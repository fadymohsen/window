<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container">
        ...
        <div class="offcanvas offcanvas-end offcanvas-lg" tabindex="-1" id="navbarOffcanvas">
            <div class="offcanvas-header d-lg-none">
                <a href="/"><img src="{{ asset('front/images/window-final logo-1.png') }}" alt="{{ $website_settings->title }}" style="height: 40px;"></a>
