            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="gap-2 mb-3 flex-fill">
                        ...
                        <textarea id="content_ar" name="ar[content]" class="form-control ck-editor-field" dir="rtl"></textarea>
                    </div>
                    <div class="gap-2 mb-3 flex-fill">
                        <label for="content_en">@lang('dashboard.en.content')</label>
                        <textarea id="content_en" name="en[content]" class="form-control ck-editor-field"></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="gap-2 mb-3 flex-fill">
                                ...
                                <input id="meta_title_ar" type="text" class="form-control" name="ar[meta_title]" maxlength="255" dir="rtl">
                            </div>
                            <div class="gap-2 mb-3 flex-fill">
                                <label for="meta_description_ar">@lang('dashboard.ar.meta_description')</label>
                                <textarea id="meta_description_ar" class="form-control" name="ar[meta_description]" rows="3" maxlength="500" dir="rtl"></textarea>
                            </div>
                            <div class="gap-2 mb-3 flex-fill">
                                <label for="meta_keywords_ar">@lang('dashboard.ar.meta_keywords')</label>
                                <input id="meta_keywords_ar" type="text" class="form-control" name="ar[meta_keywords]" maxlength="500" dir="rtl">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="gap-2 mb-3 flex-fill">
                                <label for="meta_title_en">@lang('dashboard.en.meta_title')</label>
                                <input id="meta_title_en" type="text" class="form-control" name="en[meta_title]" maxlength="255">
                            </div>
                            <div class="gap-2 mb-3 flex-fill">
                                <label for="meta_description_en">@lang('dashboard.en.meta_description')</label>
                                <textarea id="meta_description_en" class="form-control" name="en[meta_description]" rows="3" maxlength="500"></textarea>
                            </div>
                            <div class="gap-2 mb-3 flex-fill">
                                <label for="meta_keywords_en">@lang('dashboard.en.meta_keywords')</label>
                                <input id="meta_keywords_en" type="text" class="form-control" name="en[meta_keywords]" maxlength="500">
                            </div>
                        </div>
                    </div>
                </div>
