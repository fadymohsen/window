                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane active" id="tab-ar" role="tabpanel">
                            <div class="mb-3">
                                ...
                                <input id="ar-title" type="text" class="form-control" name="ar[title]" value="{{ $blog->translate('ar')?->title }}" dir="rtl">
                            </div>
                            <div class="mb-3">
                                <label for="ar-description">@lang('dashboard.description') (العربية)</label>
                                <textarea id="ar-description" name="ar[description]" class="form-control" dir="rtl">{{ $blog->translate('ar')?->description }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="ar-keywords">@lang('dashboard.keywords') (العربية)</label>
                                <input id="ar-keywords" type="text" class="form-control" name="ar[keywords]" value="{{ $blog->translate('ar')?->keywords }}" dir="rtl">
                            </div>
                            <div class="mb-3">
                                <label for="ar-meta_title">@lang('dashboard.blog_meta_title')</label>
                                <input id="ar-meta_title" type="text" class="form-control" name="ar[meta_title]" value="{{ $blog->translate('ar')?->meta_title }}" dir="rtl">
                            </div>
                            <div class="mb-3">
                                <label for="ar-meta_description">@lang('dashboard.blog_meta_description')</label>
                                <textarea id="ar-meta_description" name="ar[meta_description]" class="form-control" rows="2" dir="rtl">{{ $blog->translate('ar')?->meta_description }}</textarea>
                            </div>
                        </div>
                        <!-- English Tab -->
                        <div class="tab-pane" id="tab-en" role="tabpanel">
                            <div class="mb-3">
                                ...
                                <input id="en-title" type="text" class="form-control" name="en[title]" value="{{ $blog->translate('en')?->title }}" dir="ltr">
                            </div>
                            <div class="mb-3">
                                <label for="en-description">@lang('dashboard.description') (English)</label>
                                <textarea id="en-description" name="en[description]" class="form-control" dir="ltr">{{ $blog->translate('en')?->description }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="en-keywords">@lang('dashboard.keywords') (English)</label>
                                <input id="en-keywords" type="text" class="form-control" name="en[keywords]" value="{{ $blog->translate('en')?->keywords }}" dir="ltr">
                            </div>
                            <div class="mb-3">
                                <label for="en-meta_title">@lang('dashboard.blog_meta_title')</label>
                                <input id="en-meta_title" type="text" class="form-control" name="en[meta_title]" value="{{ $blog->translate('en')?->meta_title }}" dir="ltr">
                            </div>
                            <div class="mb-3">
                                <label for="en-meta_description">@lang('dashboard.blog_meta_description')</label>
                                <textarea id="en-meta_description" name="en[meta_description]" class="form-control" rows="2" dir="ltr">{{ $blog->translate('en')?->meta_description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input id="slug" type="text" class="form-control" name="slug" value="{{ $blog->slug }}" placeholder="auto-generated-from-title" dir="ltr">
