...
@section('title', __('dashboard.redirect_create'))
...
<form id="create-slug-redirect-form">
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                <label for="type">@lang('dashboard.redirect_type')</label>
                <select id="type" name="type" class="form-select">
                    <option value="blog">@lang('dashboard.blogs')</option>
                    <option value="service">@lang('dashboard.services')</option>
                </select>
            </div>
            <div class="mb-3">
                <label for="from_slug">@lang('dashboard.redirect_from')</label>
                <input id="from_slug" type="text" class="form-control" name="from_slug" dir="ltr" required>
            </div>
            <div class="mb-3">
                <label for="to_slug">@lang('dashboard.redirect_to')</label>
                <input id="to_slug" type="text" class="form-control" name="to_slug" dir="ltr" required>
            </div>
        </div>
    </div>
    <div class="row">
