...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'استيكرات سيارات وإعلانات مركبات في الرياض | ويندو للإعلان',
            'meta_description' => 'استيكرات سيارات مخصصة وإعلانات مركبات في الرياض — ويندو للإعلان يطبع ويركب استيكرات الدعاية والإعلان على السيارات والأساطيل التجارية في السعودية. احصل على عرض سعر مجاني.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>تسافر المركبة ذات العلامة التجارية عبر آلاف المشاهدات يومياً على طرقات الرياض. استيكرات السيارات وإعلانات المركبات تحوّل أسطول شركتك إلى حملة إعلانية خارجية متنقلة — تصل إلى جمهور لا تصله أي لوحة إعلانية أو منشور على وسائل التواصل الاجتماعي. ويندو للإعلان يصمم ويطبع ويركّب استيكرات السيارات والرسومات البصرية للمركبات للشركات في جميع أنحاء المملكة العربية السعودية.</p>
...
<p>في الرياض، حيث الاستخدام المروري مرتفع وأوقات التنقل اليومية كبيرة، يمثل أسطول من المركبات ذات العلامة التجارية في حركة المرور تعرضاً إعلانياً مستمراً عبر المدينة. ويندو للإعلان يساعد الشركات على تحويل كل رحلة إلى انطباع عن علامتها التجارية.</p>

<h2>أنواع استيكرات السيارات التي ننتجها</h2>
<p>يقدم ويندو للإعلان مجموعة كاملة من رسومات المركبات لكل تطبيق وميزانية:</p>
...
<p>يدير ويندو للإعلان مشاريع تصميم هوية الأسطول للشركات بدءاً من عمليات التوصيل الصغيرة وصولاً إلى الشركات الكبرى التي تمتلك مركبات في عدة مدن سعودية. تشمل خدمة تصميم هوية الأسطول لدينا توحيد التصميم والإنتاج المتسق عبر كل مركبة وجدولة التركيب المنسقة لتقليل الاضطراب التشغيلي.</p>
...
<p>تعتمد جودة استيكرات السيارات كلياً على فيلم الفينيل والحبر المستخدم. يستخدم ويندو للإعلان أفلام فينيل كاست معتمدة دولياً مع أحبار مذيبات مقاومة للأشعة فوق البنفسجية مُختبرة خصيصاً لمناخ المملكة العربية السعودية — درجات حرارة عالية وأشعة شمس مباشرة شديدة وأمطار عرضية.</p>
...
<p>استكشف معرض أعمالنا في مشاريع استيكرات السيارات وإعلانات المركبات في الرياض. من العلامة التجارية الشخصية لمركبة واحدة إلى حملات الأسطول متعددة المركبات، يعرض معرضنا نطاق رسومات المركبات التي أنتجها وركّبها ويندو للإعلان.</p>

<h2>الأسئلة الشائعة حول استيكرات السيارات</h2>

<h3>ما أنواع استيكرات السيارات التي ينتجها ويندو للإعلان؟</h3>
<p>ينتج ويندو للإعلان تغليف المركبات الكامل والرسومات الجزئية للمركبات واستيكرات الأبواب واللوحات واستيكرات الزجاج الخلفي المثقبة ورسومات غطاء المحرك وملصقات الأسطول. تستخدم جميع استيكرات السيارات أفلام فينيل عالية الجودة مع أحبار مقاومة للأشعة فوق البنفسجية مصنفة لمناخ السعودية الخارجي.</p>

<h3>هل يمكن إزالة استيكرات السيارات دون إتلاف طلاء المركبة؟</h3>
<p>نعم. يستخدم ويندو للإعلان أفلام فينيل قابلة للإزالة عالية الجودة تحمي طلاء المركبة الأصلي ويمكن إزالتها بنظافة دون ترك بقايا أو التسبب في تلف الطلاء. ننصح بالإزالة الاحترافية بواسطة فريقنا لضمان أفضل نتيجة.</p>

<h3>كم تكلفة تصميم هوية المركبة في الرياض؟</h3>
<p>تعتمد تكاليف تصميم هوية المركبة على حجم المركبة ونسبة التغطية (جزئية أو كاملة) وعدد المركبات. يقدم ويندو للإعلان عروض أسعار شفافة ومفصلة. تواصل معنا بنوع مركبتك وحجم أسطولك للحصول على تقدير مجاني.</p>

<h3>كم تدوم استيكرات السيارات في مناخ المملكة العربية السعودية؟</h3>
<p>عند التركيب الصحيح باستخدام أفلام فينيل عالية الجودة وأحبار مقاومة للأشعة فوق البنفسجية، تدوم استيكرات السيارات من ويندو للإعلان من 3 إلى 5 سنوات في ظروف المملكة العربية السعودية الخارجية. نستخدم مواد مصنفة خصيصاً لبيئات الحرارة العالية لمنع البهتان والتقشر.</p>

<h3>هل تتولون تصميم هوية الأسطول لعدة مركبات؟</h3>
<p>نعم. تصميم هوية الأسطول من أكثر خدماتنا طلباً. يقدم ويندو للإعلان خدمة تصميم هوية أسطول متكاملة للشركات التي تمتلك من 2 إلى أكثر من 200 مركبة — تصميم متسق عبر كل مركبة وجدولة منسقة وتركيب في جميع أنحاء الرياض والمملكة العربية السعودية.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع استيكرات السيارات التي ينتجها ويندو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ينتج ويندو للإعلان تغليف المركبات الكامل والرسومات الجزئية للمركبات واستيكرات الأبواب واللوحات واستيكرات الزجاج الخلفي المثقبة ورسومات غطاء المحرك وملصقات الأسطول. تستخدم جميع استيكرات السيارات أفلام فينيل عالية الجودة مع أحبار مقاومة للأشعة فوق البنفسجية مصنفة لمناخ السعودية الخارجي."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. يستخدم ويندو للإعلان أفلام فينيل قابلة للإزالة عالية الجودة تحمي طلاء المركبة الأصلي ويمكن إزالتها بنظافة دون ترك بقايا أو التسبب في تلف الطلاء. ننصح بالإزالة الاحترافية بواسطة فريقنا لضمان أفضل نتيجة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تعتمد تكاليف تصميم هوية المركبة على حجم المركبة ونسبة التغطية (جزئية أو كاملة) وعدد المركبات. يقدم ويندو للإعلان عروض أسعار شفافة ومفصلة. تواصل معنا بنوع مركبتك وحجم أسطولك للحصول على تقدير مجاني."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "عند التركيب الصحيح باستخدام أفلام فينيل عالية الجودة وأحبار مقاومة للأشعة فوق البنفسجية، تدوم استيكرات السيارات من ويندو للإعلان من 3 إلى 5 سنوات في ظروف المملكة العربية السعودية الخارجية. نستخدم مواد مصنفة خصيصاً لبيئات الحرارة العالية لمنع البهتان والتقشر."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تصميم هوية الأسطول من أكثر خدماتنا طلباً. يقدم ويندو للإعلان خدمة تصميم هوية أسطول متكاملة للشركات التي تمتلك من 2 إلى أكثر من 200 مركبة — تصميم متسق عبر كل مركبة وجدولة منسقة وتركيب في جميع أنحاء الرياض والمملكة العربية السعودية."
      }
    }
  ]
}
