...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'صناديق توصيل حرارية في الرياض | صناديق معزولة مخصصة السعودية | ويندو للإعلان',
            'meta_description' => 'صناديق توصيل حرارية مخصصة في الرياض — ويندو للإعلان يصمم وينتج صناديق توصيل معزولة مع طباعة مخصصة كاملة لشركات التوصيل والتموين والهدايا الشركاتية في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>جودة الصندوق الحراري تعكس جودة ما بداخله — وجودة العلامة التجارية التي أرسلته. صندوق حراري مميز ومصمم بعناية ومطبوع بجودة عالية يوحي بأن الشركة تقدر منتجها وتجربة عملائها. ويندو للإعلان يصمم صناديق توصيل حرارية تعمل كأصول إعلانية وليس مجرد تغليف تشغيلي.</p>

<h2>مواصفات الصناديق الحرارية للسوق السعودية</h2>
<p>متطلبات العزل لتوصيل الطعام في الرياض أعلى بكثير مما هي عليه في المناخات الأبرد. في ظروف الصيف، يمكن أن يتجاوز الفرق بين داخل صندوق التوصيل ودرجة الحرارة الخارجية 40 درجة مئوية. ويندو للإعلان يحدد مواصفات الصناديق الحرارية للسوق السعودي بعزل مناسب لمسافة ووقت التوصيل المطلوب.</p>
...
<p>لشركات المطاعم والتوصيل الغذائي في جميع أنحاء الرياض، العلامة التجارية على صناديق التوصيل الحرارية هي قناة إعلانية عالية الظهور تنشط مع كل عملية توصيل. ويندو للإعلان يصمم علامات تجارية للصناديق الحرارية تعمل على نطاق السطح الخارجي للصندوق — وضع شعار جريء، وألوان العلامة التجارية، ورسائل تُقرأ بوضوح عند عتبة الباب ومن الجهة المقابلة للشارع.</p>
<p>لشركات التوصيل الغذائي التي تدير حجماً عالياً من التوصيلات، العرض المتسق للعلامة التجارية عبر كل صندوق حراري في الأسطول يخلق حضوراً منسقاً للعلامة التجارية في أحياء الرياض. ويندو للإعلان ينتج صناديق التوصيل الحرارية بكميات كبيرة — من كميات بداية تبلغ 100 وحدة إلى طلبات الأساطيل الكبيرة.</p>
...
<h3>ما أنواع صناديق التوصيل الحرارية التي ينتجها ويندو للإعلان؟</h3>
<p>ينتج ويندو للإعلان صناديق توصيل معزولة من البوليسترين الممدد (فوم EPS) مع أغلفة خارجية مميزة أو سطوح مطبوعة، وكرتون مموج صلب مع بطانات عزل رقائقية لتوصيل الطعام، وصناديق معزولة بفوم البولي يوريثين للحفاظ على الحرارة عالي الأداء، وحقائب توصيل معزولة قابلة لإعادة الاستخدام من النايلون والبوليستر مع طباعة مميزة بالألوان الكاملة.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع صناديق التوصيل الحرارية التي ينتجها ويندو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ينتج ويندو للإعلان صناديق توصيل معزولة من البوليسترين الممدد (فوم EPS) مع أغلفة خارجية مميزة أو سطوح مطبوعة، وكرتون مموج صلب مع بطانات عزل رقائقية لتوصيل الطعام، وصناديق معزولة بفوم البولي يوريثين للحفاظ على الحرارة عالي الأداء، وحقائب توصيل معزولة قابلة لإعادة الاستخدام من النايلون والبوليستر مع طباعة مميزة بالألوان الكاملة."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. ويندو للإعلان يحدد مواصفات صناديق التوصيل الحرارية بعزل مناسب لبيئة درجات الحرارة المحيطة العالية في المملكة العربية السعودية. في ظروف صيف الرياض، يحافظ الصندوق المعزول القياسي على درجات حرارة باردة لمدة 2 إلى 4 ساعات حسب درجة العزل وعدد مرات فتحه. تتوفر مواصفات عزل أعلى لأوقات التوصيل الأطول أو المحتويات الحساسة للحرارة بشكل خاص."
      }
    },
    {
      "@type": "Question",
