...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'مطبوعات يوم التأسيس في الرياض | طباعة إعلانات يوم التأسيس السعودي | ويندو للإعلان',
            'meta_description' => 'مطبوعات وإعلانات يوم التأسيس السعودي في الرياض — ويندو للإعلان ينتج استيكرات وأعلام ولافتات وخلفيات تصوير وهدايا مطبوعة مميزة ليوم التأسيس. دعاية واعلان الرياض. احصل على عرض سعر.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>يوم التأسيس السعودي في 22 فبراير يحتفي بتأسيس الدولة السعودية الأولى — وللمؤسسات في جميع أنحاء الرياض، يتطلب ذلك مجموعة منسقة من المطبوعات والمواد الإعلانية التي تحترم المناسبة بهويتها البصرية التراثية المميزة. ويندو للإعلان ينتج كامل مطبوعات <a href="/ar/services/founding-day-celebrations">احتفالات يوم التأسيس</a> للشركات والجهات الحكومية: أعلام ولافتات واستيكرات وخلفيات فعاليات وهدايا مطبوعة بالهوية البصرية ليوم التأسيس.</p>
...
<p>يصمم ويندو للإعلان مواد يوم التأسيس الإعلانية بالهوية البصرية المناسبة — ليست مجرد مطبوعات يوم وطني مُعاد تلوينها، بل نهج تصميمي مستقل يعكس الأهمية التراثية للمناسبة. كل مطبوعة تُنتج بهوية العميل التجارية إلى جانب تصميم مناسبة يوم التأسيس.</p>

<h2>أعلام ولافتات يوم التأسيس</h2>
<p>تخلق <a href="/ar/services/flags">الأعلام</a> واللافتات ليوم التأسيس الأجواء البصرية للمناسبة عبر مداخل المباني والردهات والمكاتب والمساحات الخارجية. ينتج ويندو للإعلان أعلام يوم التأسيس بأحجام قياسية ومخصصة، ولافتات داخلية وخارجية بتصميم يوم التأسيس، وأعلام على شكل قطرة وريشة لتركيبات المداخل، ومجموعات لافتات معلقة لعرض الأتريوم والممرات.</p>
...
<p>لمجموعات هدايا يوم التأسيس المؤسسية، ينتج ويندو للإعلان صناديق هدايا وأكياس وورق تغليف وبطاقات هدايا مطبوعة بهوية يوم التأسيس. يدمج تصميم تغليف الهدايا شعار الشركة مع تصميم مناسبة يوم التأسيس — للتعبير عن هوية المؤسسة والاحتفاء بالمناسبة معاً. تعد <a href="/ar/services/employee-gift-boxes">صناديق هدايا الموظفين</a> من أكثر طلبات مطبوعات يوم التأسيس شيوعاً التي ننفذها كل عام.</p>
<p>للفعاليات الرسمية ليوم التأسيس، ينتج ويندو للإعلان برامج فعاليات ثنائية اللغة بالعربية والإنجليزية، وشهادات تقدير بتصميم رسمي مستوحى من التراث، وخلفيات تصوير للفعاليات، ومواد ترتيب الطاولات لحفلات العشاء وحفلات التكريم.</p>
...
<h3>ما المطبوعات التي ينتجها ويندو للإعلان ليوم التأسيس؟</h3>
<p>ينتج ويندو للإعلان كامل مطبوعات يوم التأسيس الإعلانية: أعلام يوم التأسيس بأحجام قياسية ومخصصة، ولافتات فينيل ولافتات داخلية بالهوية البصرية ليوم التأسيس، وخلفيات تصوير، واستيكرات جدارية ونوافذ بزخارف يوم التأسيس التراثية، وتغليف هدايا مؤسسية تشمل صناديق وورق تغليف، وبرامج فعاليات، وشهادات تقدير، وطباعة تيشيرتات وأوشحة لاحتفالات الموظفين.</p>

<h3>ما الأسلوب البصري المستخدم في مطبوعات يوم التأسيس؟</h3>
<p>ليوم التأسيس هوية بصرية مميزة تختلف عن اليوم الوطني. تستلهم جماليات يوم التأسيس من التراث السعودي — بدمج عناصر تشير إلى فترة التأسيس عام 1727، وتقاليد الخط العربي، والجذور التاريخية للدولة السعودية. لوحة الألوان أكثر ذهبية وترابية مقارنة بالأخضر والأبيض الزاهي لليوم الوطني. يصمم فريق ويندو للإعلان مواد يوم التأسيس بالهوية البصرية المناسبة لعلامة كل عميل.</p>

<h3>متى يجب تقديم طلبات مطبوعات يوم التأسيس؟</h3>
<p>يوصي ويندو للإعلان بتقديم طلبات مطبوعات يوم التأسيس قبل 3 إلى 4 أسابيع على الأقل من 22 فبراير. نما الطلب على الإنتاج حول يوم التأسيس بشكل ملحوظ مع ترسخ المناسبة في الأجندة المؤسسية. الطلبات المقدمة في يناير تتيح أقصى مرونة في التصميم ووقت إنتاج وتسليم كافٍ.</p>

<h3>هل تقومون بتوصيل مطبوعات يوم التأسيس في جميع أنحاء الرياض؟</h3>
<p>نعم. يوصل ويندو للإعلان جميع طلبات مطبوعات يوم التأسيس في جميع أنحاء الرياض. للمؤسسات ذات الفروع المتعددة، ننسق جدولة التوصيل لضمان وصول جميع المواد لكل موقع قبل احتفال 22 فبراير.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما المطبوعات التي ينتجها ويندو للإعلان ليوم التأسيس؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ينتج ويندو للإعلان كامل مطبوعات يوم التأسيس الإعلانية: أعلام يوم التأسيس بأحجام قياسية ومخصصة، ولافتات فينيل ولافتات داخلية بالهوية البصرية ليوم التأسيس، وخلفيات تصوير، واستيكرات جدارية ونوافذ بزخارف يوم التأسيس التراثية، وتغليف هدايا مؤسسية تشمل صناديق وورق تغليف، وبرامج فعاليات، وشهادات تقدير، وطباعة تيشيرتات وأوشحة لاحتفالات الموظفين."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ليوم التأسيس هوية بصرية مميزة تختلف عن اليوم الوطني. تستلهم جماليات يوم التأسيس من التراث السعودي — بدمج عناصر تشير إلى فترة التأسيس عام 1727، وتقاليد الخط العربي، والجذور التاريخية للدولة السعودية. لوحة الألوان أكثر ذهبية وترابية مقارنة بالأخضر والأبيض الزاهي لليوم الوطني. يصمم فريق ويندو للإعلان مواد يوم التأسيس بالهوية البصرية المناسبة لعلامة كل عميل."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "يوصي ويندو للإعلان بتقديم طلبات مطبوعات يوم التأسيس قبل 3 إلى 4 أسابيع على الأقل من 22 فبراير. نما الطلب على الإنتاج حول يوم التأسيس بشكل ملحوظ مع ترسخ المناسبة في الأجندة المؤسسية. الطلبات المقدمة في يناير تتيح أقصى مرونة في التصميم ووقت إنتاج وتسليم كافٍ."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. يوصل ويندو للإعلان جميع طلبات مطبوعات يوم التأسيس في جميع أنحاء الرياض. للمؤسسات ذات الفروع المتعددة، ننسق جدولة التوصيل لضمان وصول جميع المواد لكل موقع قبل احتفال 22 فبراير."
      }
    }
  ]
}
