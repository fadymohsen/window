...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'دانقلر دعائي في الرياض | إعلانات معلقة مخصصة السعودية | ويندو للإعلان',
            'meta_description' => 'دانقلرات دعائية وإعلانات معلقة في الرياض — ويندو للإعلان يصمم وينتج دانقلرات للمحلات التجارية والمعارض والسيارات والفعاليات في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>تصمم ويندو للإعلان دانقلرات تجزئة جريئة بما يكفي لرؤيتها من مسافة الممر، وواضحة بما يكفي لإيصال الرسالة بقراءة سريعة، ومنتجة بجودة تعكس العلامة التجارية. الدانقلرات المطبوعة على الوجهين تنقل نفس الرسالة للمتسوقين القادمين من أي اتجاه. مع <a href="/ar/services/wall-stickers">ستيكرات الحوائط</a>، تخلق الدانقلرات بيئة متجر متكاملة العلامة التجارية.</p>
...
<p>تنتج ويندو للإعلان دانقلرات المرايا الخلفية بالورق المقوى العادي والورق المعطر (كمعطر جو مؤسسي) والأشكال الصلبة المقصوصة حسب الطلب بأشكال العلامة التجارية. تُنتج الدانقلرات بشعار الشركة والعلامة التجارية على الوجهين وتأتي مع خيوط تعليق أو أشرطة أو حبال مطبوعة حسب الطلب.</p>
...
<p>تطور ويندو للإعلان قوالب قص مخصصة للدانقلرات الدعائية، مما يتيح الإنتاج بأي شكل يخدم أهداف التواصل البصري للعلامة التجارية. الدانقلرات المقصوصة بأشكال فريدة أكثر فعالية في جذب الانتباه من الأشكال المستطيلة العادية.</p>
...
<p>تنتج ويندو للإعلان الدانقلرات الدعائية على الورق المقوى المطلي (المادة الأكثر شيوعاً لدانقلرات التجزئة والفعاليات)، والفوم بورد السميك لعروض الأسقف المعلقة كبيرة الحجم، والأسيتات الشفاف لدانقلرات شفافة بتأثير فاخر، والـ PVC الصلب لدانقلرات الهواء الطلق والسيارات، ومواد متخصصة تشمل قشرة الخشب والأكريليك للدانقلرات المؤسسية الفاخرة المستخدمة في الهدايا الراقية والضيافة.</p>

<h3>هل يمكن إنتاج الدانقلرات بأشكال مخصصة؟</h3>
<p>نعم. الدانقلرات المقصوصة بأي شكل مخصص — شعار الشركة، صورة منتج ظلية، زخرفة مناسبة وطنية، أو أي تصميم مخصص — هي تطبيق مميز. الدانقلرات المقصوصة بأشكال ذات صلة بالعلامة التجارية أكثر تميزاً وتذكراً من البطاقات المستطيلة العادية. تتولى ويندو للإعلان تصميم قالب القص والإنتاج للدانقلرات ذات الأشكال المخصصة.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تنتج ويندو للإعلان الدانقلرات الدعائية على الورق المقوى المطلي (المادة الأكثر شيوعاً لدانقلرات التجزئة والفعاليات)، والفوم بورد السميك لعروض الأسقف المعلقة كبيرة الحجم، والأسيتات الشفاف لدانقلرات شفافة بتأثير فاخر، والـ PVC الصلب لدانقلرات الهواء الطلق والسيارات، ومواد متخصصة تشمل قشرة الخشب والأكريليك للدانقلرات المؤسسية الفاخرة المستخدمة في الهدايا الراقية والضيافة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. الدانقلرات المقصوصة بأي شكل مخصص — شعار الشركة، صورة منتج ظلية، زخرفة مناسبة وطنية، أو أي تصميم مخصص — هي تطبيق مميز. الدانقلرات المقصوصة بأشكال ذات صلة بالعلامة التجارية أكثر تميزاً وتذكراً من البطاقات المستطيلة العادية. تتولى ويندو للإعلان تصميم قالب القص والإنتاج للدانقلرات ذات الأشكال المخصصة."
      }
    },
    {
      "@type": "Question",
