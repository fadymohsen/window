...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'استندات رول أب في الرياض | استندات دعائية قابلة للطي | وينوو للإعلان',
            'meta_description' => 'استندات رول أب مخصصة في الرياض — وينوو للإعلان يصمم وينتج استندات دعائية قابلة للطي للمعارض والفعاليات والترويج للشركات في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>للشركات السعودية المشاركة في المعارض والمعارض التجارية والفعاليات المؤسسية، تمثل استندات الرول أب أسرع وأوفر طريقة لإنشاء عرض مؤسسي احترافي في أي مساحة. استندات الرول أب من وينوو للإعلان تُنتج وفق معايير جودة العرض المتوقعة في أبرز صالات المعارض بالمملكة.</p>

<h2>أنواع استندات الرول أب وأشكالها</h2>
<p>يوفر وينوو للإعلان استندات رول أب في ثلاث فئات رئيسية:</p>
...
<p>الرسم المطبوع هو العنصر الذي يحدد مدى فعالية استند الرول أب في بيئة المعرض. فريق التصميم في وينوو للإعلان ينتج رسومات رول أب تتبع مبادئ الإعلان العرضي — صورة مهيمنة واحدة، وتسلسل واضح للمعلومات، ورسالة يمكن قراءتها من مسافة ثلاثة إلى خمسة أمتار.</p>
...
<p>للفعاليات التي تتطلب عشرة استندات رول أب أو أكثر — مثل الإطلاقات المؤسسية متعددة المواقع أو الحملات الترويجية المتنقلة أو حملات المعارض عبر عدة مدن سعودية — يدير وينوو للإعلان الإنتاج ومراقبة الجودة وتنسيق التوصيل للمجموعة بأكملها. كل بانر يُعنوَن ويُعبأ ويُسلّم في حقيبة حمل بشكل فردي، مع قائمة جرد مسماة لسهولة التوزيع على فرق الفعاليات.</p>
...
<p>المقاس الأكثر شيوعاً لاستند الرول أب في المعارض والفعاليات بالمملكة العربية السعودية هو 85 سم عرضاً في 200 سم طولاً. استندات الرول أب العريضة تتراوح من 100 سم إلى 150 سم عرضاً للتطبيقات التي تحتاج سطح عرض أكبر. وينوو للإعلان ينصح بالمقاس الأنسب بناءً على مساحة البوث أو العرض ومسافة المشاهدة.</p>

<h3>كم يستغرق إنتاج استند الرول أب؟</h3>
<p>إنتاج استند الرول أب العادي يستغرق من 2 إلى 4 أيام عمل من اعتماد التصميم. الإنتاج السريع خلال 24 ساعة متاح للمواعيد العاجلة للمعارض والفعاليات. وينوو للإعلان يدير التصميم والطباعة والتجميع داخلياً، مما يتيح تسليماً سريعاً للطلبات في اللحظة الأخيرة.</p>

<h3>هل يمكن استبدال الطباعة على استند رول أب موجود؟</h3>
<p>نعم. استندات الرول أب مصممة لاستبدال الرسومات — آلية الكاسيت تحمل البانر المطبوع الذي يمكن تبديله عند تغيير حملتك أو رسالة علامتك التجارية. وينوو للإعلان يوفر رسومات رول أب بديلة للاستندات الموجودة، مما يقلل تكلفة تحديث نظام العرض الخاص بك.</p>

<h3>هل استندات الرول أب مناسبة للاستخدام الخارجي؟</h3>
<p>استندات الرول أب العادية مصممة للاستخدام الداخلي. للاستخدام الخارجي، ينصح وينوو للإعلان بالاستندات القابلة للطي المصنفة للاستخدام الخارجي مع قواعد مثقلة ووسائط طباعة مقاومة للأشعة فوق البنفسجية، أو أنظمة بانرات خارجية مصممة خصيصاً لظروف الرياح والحرارة في المملكة العربية السعودية.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "المقاس الأكثر شيوعاً لاستند الرول أب في المعارض والفعاليات بالمملكة العربية السعودية هو 85 سم عرضاً في 200 سم طولاً. استندات الرول أب العريضة تتراوح من 100 سم إلى 150 سم عرضاً للتطبيقات التي تحتاج سطح عرض أكبر. وينوو للإعلان ينصح بالمقاس الأنسب بناءً على مساحة البوث أو العرض ومسافة المشاهدة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "إنتاج استند الرول أب العادي يستغرق من 2 إلى 4 أيام عمل من اعتماد التصميم. الإنتاج السريع خلال 24 ساعة متاح للمواعيد العاجلة للمعارض والفعاليات. وينوو للإعلان يدير التصميم والطباعة والتجميع داخلياً، مما يتيح تسليماً سريعاً للطلبات في اللحظة الأخيرة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. استندات الرول أب مصممة لاستبدال الرسومات — آلية الكاسيت تحمل البانر المطبوع الذي يمكن تبديله عند تغيير حملتك أو رسالة علامتك التجارية. وينوو للإعلان يوفر رسومات رول أب بديلة للاستندات الموجودة، مما يقلل تكلفة تحديث نظام العرض الخاص بك."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "استندات الرول أب العادية مصممة للاستخدام الداخلي. للاستخدام الخارجي، ينصح وينوو للإعلان بالاستندات القابلة للطي المصنفة للاستخدام الخارجي مع قواعد مثقلة ووسائط طباعة مقاومة للأشعة فوق البنفسجية، أو أنظمة بانرات خارجية مصممة خصيصاً لظروف الرياح والحرارة في المملكة العربية السعودية."
      }
    }
  ]
}
