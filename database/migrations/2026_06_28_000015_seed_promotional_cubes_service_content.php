...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'مكعبات دعائية في الرياض | مكعبات عرض مميزة | ويندو للإعلان',
            'meta_description' => 'مكعبات دعائية مخصصة في الرياض — ويندو للإعلان ينتج مكعبات عرض بالقماش والطباعة لبوثات المعارض والمتاجر والفعاليات الشركاتية في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>الأحجام القياسية للمكعبات الدعائية التي تنتجها ويندو للإعلان هي 40 سم و50 سم و60 سم لكل ضلع — وتغطي النطاق من منصات عرض المنتجات الصغيرة إلى مكعبات بارتفاع مقعد مريح. تتوفر أحجام مخصصة للمشاريع التي تتطلب ارتفاعات غير قياسية أو علاقات تناسبية محددة بين عدة مكعبات في المجموعة.</p>
...
<p>تصمم ويندو للإعلان مجموعات المكعبات لتتناسق مع لوحة الألوان والهوية البصرية للبوث الأوسع — <a href="/ar/services/lama-stand">ستاندات لاما</a> و<a href="/ar/services/roll-up">بانرات رول أب</a> والمكعبات الدعائية تشترك جميعها في نفس لغة التصميم. والنتيجة هي بيئة معرض تبدو مصممة بشكل متعمد وليست مجمعة من عناصر غير مترابطة.</p>
...
<p>تنتج ويندو للإعلان مكعبات دعائية من هياكل إطارات ألمنيوم خفيفة مغطاة بقماش مطبوع بتقنية التسامي الحراري، وفوم صلب مغطى بالقماش أو الفينيل، وبناء ألواح صلبة مطبوعة. يعتمد اختيار المادة على ما إذا كان المكعب سيُستخدم كمقعد أو منصة عرض منتجات أو عنصر عرض بحت.</p>

<h3>هل يمكن استخدام المكعبات الدعائية كمقاعد؟</h3>
<p>نعم. المكعبات الدعائية ذات السطح العلوي المبطن أو الفوم وبناء الإطار المتين مناسبة للاستخدام كمقاعد في مناطق استراحة بوثات المعارض. تحدد ويندو للإعلان درجة الإطار والمواد بناءً على الاستخدام المقصود — المكعبات المخصصة للعرض فقط تستخدم مواد خفيفة، بينما مكعبات الجلوس تستخدم إطارات معززة مصنفة للاستخدام المستمر.</p>

<h3>هل المكعبات الدعائية قابلة للتكديس؟</h3>
<p>نعم. تنتج ويندو للإعلان مجموعات مكعبات دعائية قابلة للتكديس بأحجام قياسية تتداخل معاً لإنشاء هياكل عرض منتجات متدرجة أو تركيبات بصرية للعلامة التجارية. تتضمن أقواس تكديس لمنع عدم الاستقرار في التكوينات المكونة من ثلاثة مكعبات أو أكثر ارتفاعاً.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تنتج ويندو للإعلان مكعبات دعائية من هياكل إطارات ألمنيوم خفيفة مغطاة بقماش مطبوع بتقنية التسامي الحراري، وفوم صلب مغطى بالقماش أو الفينيل، وبناء ألواح صلبة مطبوعة. يعتمد اختيار المادة على ما إذا كان المكعب سيُستخدم كمقعد أو منصة عرض منتجات أو عنصر عرض بحت."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تنتج ويندو للإعلان مجموعات مكعبات دعائية قابلة للتكديس بأحجام قياسية تتداخل معاً لإنشاء هياكل عرض منتجات متدرجة أو تركيبات بصرية للعلامة التجارية. تتضمن أقواس تكديس لمنع عدم الاستقرار في التكوينات المكونة من ثلاثة مكعبات أو أكثر ارتفاعاً."
      }
    }
  ]
}
