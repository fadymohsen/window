...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'لافتات إرشادية في الرياض | إشارات توجيهية السعودية | وينوو للإعلان',
            'meta_description' => 'لافتات إرشادية وأنظمة توجيهية مخصصة في الرياض — وينوو للإعلان يصمم وينتج لافتات الإرشاد للمكاتب والمباني والفعاليات والمستشفيات ومواقع البناء. دعاية واعلان الرياض والسعودية. احصل على عرض سعر.',
...
<p>في البيئة المؤسسية والحكومية في الرياض، تعكس أنظمة التوجيه المصممة باحترافية الكفاءة التشغيلية والوضوح التنظيمي. فهي تقلل العبء على موظفي الاستقبال، وتحسّن تجربة الزوار لأول مرة، وتساهم في صورة الدعاية والإعلان المهنية التي تقدمها منظمتك للعالم الخارجي. وينوو للإعلان يصمم لافتات إرشادية تتكامل مع هويتك المؤسسية والطابع المادي لمساحتك.</p>

<h2>أنواع اللافتات الإرشادية التي ننتجها</h2>
<p>ينتج وينوو للإعلان المجموعة الكاملة من أشكال اللافتات الإرشادية المطلوبة للمباني والفعاليات في جميع أنحاء المملكة العربية السعودية:</p>
...
<p>لوحات أسماء الأبواب تحدد الغرف والمكاتب والأقسام الفردية. ينتج وينوو للإعلان لوحات أسماء من الألمنيوم والأكريليك وأنظمة لوحات أسماء LED مضيئة بتصاميم متناسقة تتوافق مع نظام اللافتات الأوسع.</p>
...
<p>كل لافتة إرشادية ينتجها وينوو للإعلان للسوق السعودية متوفرة بتنسيق ثنائي اللغة بالعربية والإنجليزية. يتولى فريق التصميم لدينا التنضيد والتخطيط العربي — ليس ترجمة لاحقة، بل نص عربي مؤلف بشكل صحيح وبحجم مناسب يعمل كطبقة اللغة الأساسية للجمهور السعودي.</p>
<p>تتطلب أنظمة اللافتات للمباني الحكومية والمستشفيات والمؤسسات التعليمية عادةً العربية كلغة أساسية مع الإنجليزية كلغة ثانوية. بينما تحدد البيئات المؤسسية والضيافة في الرياض في كثير من الأحيان عرضاً ثنائي اللغة متساوي الوزن. يصمم وينوو للإعلان لكلا المتطلبين وينصح بالتسلسل اللغوي الأمثل لتطبيقك المحدد.</p>

<h2>المواد والتصنيع</h2>
<p>تعتمد مواصفات المواد للافتات الإرشادية على البيئة وموقع اللافتة بالنسبة لمصادر الإضاءة والجمالية المطلوبة. يعمل وينوو للإعلان مع المجموعة الكاملة من المواد المستخدمة في أنظمة التوجيه الاحترافية:</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع اللافتات الإرشادية التي ينتجها وينوو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "يوفر وينوو للإعلان خيارات التوريد فقط والتوريد والتركيب الكامل للافتات الإرشادية. يتولى فريق التركيب لدينا التثبيت والمحاذاة وإدارة الكابلات للافتات المعلقة من السقف والأنظمة المثبتة على الجدران واللافتات الخارجية المثبتة على أعمدة. ننسق جدولة التركيب لتقليل التأثير على عمليات المبنى."
      }
    },
    {
      "@type": "Question",
