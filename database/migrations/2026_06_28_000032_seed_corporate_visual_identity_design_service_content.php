...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تصميم الهوية البصرية الشركاتية في الرياض | هوية تجارية السعودية | ويندو للإعلان',
            'meta_description' => 'تصميم هوية بصرية شركاتية متكاملة في الرياض — ويندو للإعلان يصمم أنظمة هوية بصرية متكاملة تشمل الشعار والألوان والخطوط والأدلة والقرطاسية والبروفيل لشركات السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>تتعامل ويندو للإعلان مع الهوية البصرية الشركاتية كمشروع تصميم استراتيجي — وليس مجرد تمرين جمالي. تبدأ العملية بفهم المؤسسة:</p>
...
<p>الاختبار الحقيقي للهوية الشركاتية هو أداؤها عبر النطاق الكامل من الوسائط التي تظهر فيها الشركة. تصمم ويندو للإعلان الهويات مع وضع التطبيق في الاعتبار — وتنفذ تلك الهويات عبر الطيف الإعلامي الكامل كامتداد طبيعي لعمل التصميم.</p>
...
<p>ميزة العمل مع ويندو للإعلان في تصميم الهوية وتنفيذها هي أن كل تطبيق ينتجه الفريق الذي صمم النظام — مما يضمن دقة الألوان وصحة الخطوط والتنفيذ الأمين للهوية عبر كل وسيط.</p>
...
<p>نعم. تصمم ويندو للإعلان أنظمة هوية شركاتية تعمل بالعربية والإنجليزية — وهذا أمر أساسي للسوق السعودي. يجب اختيار الخط العربي في بيئة الأعمال السعودية وتنسيقه بعناية ليتطابق مع جودة وطابع الخطوط اللاتينية في نفس النظام. نطوّر قفلات شعار ثنائية اللغة وقرطاسية ثنائية اللغة وإرشادات تغطي تطبيق الخطوط العربية.</p>

<h3>هل يمكن لويندو للإعلان إعادة تصميم هوية قائمة بدلاً من إنشاء هوية جديدة؟</h3>
<p>نعم. مشاريع تحديث وتطوير الهوية شائعة — الهدف عادةً هو تحديث هوية قائمة مع الحفاظ على قيمة العلامة التجارية المتراكمة على مر السنين. تجري ويندو للإعلان تدقيقاً للعلامة التجارية قبل بدء مشروع إعادة التصميم لفهم العناصر التي تحمل قيمة تعريفية ويجب تطويرها بدلاً من التخلص منها.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "يتضمن مشروع الهوية البصرية الشركاتية المتكامل من ويندو للإعلان: تصميم الشعار (إصدارات أساسية وثانوية وأحادية اللون)، ولوحة ألوان العلامة التجارية مع الألوان الأساسية والثانوية ومواصفاتها (HEX، RGB، CMYK، Pantone)، ونظام الخطوط (خطوط أساسية وثانوية للعناوين والنصوص)، ووثيقة إرشادات استخدام العلامة التجارية، وتصميم بطاقات العمل والقرطاسية، وقالب التوقيع الإلكتروني، وقوالب ملفات التواصل الاجتماعي، وتصميم بروفيل الشركة. تتوفر مخرجات إضافية تشمل مواصفات اللافتات وتغليف المركبات ورسوم الفيديو المتحركة كجزء من باقات الهوية الموسعة."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تصمم ويندو للإعلان أنظمة هوية شركاتية تعمل بالعربية والإنجليزية — وهذا أمر أساسي للسوق السعودي. يجب اختيار الخط العربي في بيئة الأعمال السعودية وتنسيقه بعناية ليتطابق مع جودة وطابع الخطوط اللاتينية في نفس النظام. نطوّر قفلات شعار ثنائية اللغة وقرطاسية ثنائية اللغة وإرشادات تغطي تطبيق الخطوط العربية."
      }
    },
    {
      "@type": "Question",
      "name": "هل يمكن لويندو للإعلان إعادة تصميم هوية قائمة بدلاً من إنشاء هوية جديدة؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. مشاريع تحديث وتطوير الهوية شائعة — الهدف عادةً هو تحديث هوية قائمة مع الحفاظ على قيمة العلامة التجارية المتراكمة على مر السنين. تجري ويندو للإعلان تدقيقاً للعلامة التجارية قبل بدء مشروع إعادة التصميم لفهم العناصر التي تحمل قيمة تعريفية ويجب تطويرها بدلاً من التخلص منها."
      }
    }
  ]
}
