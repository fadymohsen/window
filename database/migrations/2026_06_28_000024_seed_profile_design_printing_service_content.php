...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تصميم بروفيل وطباعته في الرياض | بروفيل شركات السعودية | ويندو للإعلان',
            'meta_description' => 'تصميم وطباعة بروفيل شركات في الرياض — ويندو للإعلان يصمم ويطبع بروفيلات شركاتية احترافية وكتالوجات وتقارير سنوية للشركات في السعودية. دعاية واعلان الرياض وتصميم هوية متكامل. احصل على عرض سعر.',
...
<p>إلى جانب بروفيلات الشركات، يصمم ويطبع ويندو للإعلان النطاق الكامل من <a href="/ar/services/business-prints">المطبوعات التجارية</a> المؤسسية:</p>
<p>كتالوجات المنتجات تعرض مجموعة منتجات الشركة بتنسيق منظم وغني بصرياً. تصميم الكتالوج يتطلب تنظيماً دقيقاً لمعلومات المنتجات والأسعار والمواصفات والتصوير في تخطيط سهل التصفح وجذاب بصرياً. ويندو للإعلان يصمم كتالوجات تعمل كأدوات إعلانية — ليست مجرد قوائم منتجات، بل وثائق تبيع.</p>
...
<p>ويندو للإعلان يقدم التصميم والطباعة معاً. فريق التصميم لدينا يتولى تصميم البروفيل الكامل من هيكلة المحتوى والتخطيط إلى الطباعة والصور والإنفوجرافيك. نعمل مع محتواك أو يمكننا مساعدتك في تطوير المحتوى المكتوب للبروفيل. بمجرد اعتماد التصميم، نتولى الطباعة وفق المواصفات المطلوبة.</p>

<h3>هل يمكن إنتاج البروفيل باللغتين العربية والإنجليزية؟</h3>
<p>نعم. ويندو للإعلان ينتج بروفيلات الشركات بتنسيق ثنائي اللغة عربي-إنجليزي — إما كوثيقة واحدة بكلتا اللغتين، أو كنسختين عربية وإنجليزية منفصلتين من نفس التصميم. التنضيد والتخطيط العربي يُنفَّذ داخلياً. كلتا النسختين تتشاركان نفس الهوية البصرية والصور ومعايير العلامة التجارية.</p>

<h3>ما خيارات التشطيب المتاحة للبروفيلات المطبوعة؟</h3>
<p>ويندو للإعلان يقدم بروفيلات الشركات بمجموعة من خيارات التشطيب: غلاف ناعم مع تغليف لامع أو مطفأ، غلاف صلب مع طلاء UV موضعي، تجليد مثالي للكتالوجات السميكة، تجليد بالدبوس المعدني للوثائق القصيرة، وتجليد حلزوني أو سلكي للوثائق التقنية والتقارير. طلاء UV الموضعي على شعار الغلاف هو تشطيب فاخر شائع للبروفيلات المؤسسية السعودية.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ويندو للإعلان يقدم التصميم والطباعة معاً. فريق التصميم لدينا يتولى تصميم البروفيل الكامل من هيكلة المحتوى والتخطيط إلى الطباعة والصور والإنفوجرافيك. نعمل مع محتواك أو يمكننا مساعدتك في تطوير المحتوى المكتوب للبروفيل. بمجرد اعتماد التصميم، نتولى الطباعة وفق المواصفات المطلوبة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. ويندو للإعلان ينتج بروفيلات الشركات بتنسيق ثنائي اللغة عربي-إنجليزي — إما كوثيقة واحدة بكلتا اللغتين، أو كنسختين عربية وإنجليزية منفصلتين من نفس التصميم. التنضيد والتخطيط العربي يُنفَّذ داخلياً. كلتا النسختين تتشاركان نفس الهوية البصرية والصور ومعايير العلامة التجارية."
      }
    },
    {
      "@type": "Question",
