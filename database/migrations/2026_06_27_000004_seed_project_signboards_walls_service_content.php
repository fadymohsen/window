...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'لوحات المشاريع وطباعة الأسوار في الرياض | وينوو للإعلان',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>مواقع البناء هي عقارات عالية الرؤية. تحوّل وينوو للإعلان حدود المشاريع ومواقع التطوير إلى بيانات علامة تجارية قوية — تصميم وطباعة وتركيب لوحات هوية المشاريع وأسوار البناء للمطورين والمقاولين والمشاريع الحكومية في جميع أنحاء الرياض والمملكة العربية السعودية.</p>
...
<p>تنتج وتركب وينوو للإعلان مجموعة كاملة من لوحات المشاريع لسوق البناء والعقارات السعودي:</p>
...
<p>تدرك وينوو للإعلان هذا. نطبق نفس معايير التصميم والإنتاج على سور البناء كما نفعل مع أي حملة علامة تجارية كبرى — لأن سمعة مشروعك تبدأ من السور المحيط.</p>
...
<p>لوحات المشاريع هي لافتات تعريف مستقلة — عادةً لوحة كبيرة واحدة تعرض هوية المشروع. أسوار البناء (وتُسمى أيضاً ألواح الحواجز أو الأسوار المحيطة) هي حواجز مطبوعة متصلة تلتف حول محيط موقع البناء، تجمع بين الحاجز الأمني والاتصالات التجارية. توفر وينوو للإعلان كليهما.</p>
...
<p>نعم. تركب وينوو للإعلان لوحات المشاريع وأسوار البناء في جميع أنحاء الرياض، مع مشاريع تُنفذ على مستوى المدينة. يدير فريق التركيب لدينا الزيارة الميدانية الكاملة والتثبيت الهيكلي وجميع المعدات المطلوبة لتركيب كامل ومقاوم للطقس.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "لوحات المشاريع هي لافتات تعريف مستقلة — عادةً لوحة كبيرة واحدة تعرض هوية المشروع. أسوار البناء (وتُسمى أيضاً ألواح الحواجز أو الأسوار المحيطة) هي حواجز مطبوعة متصلة تلتف حول محيط موقع البناء، تجمع بين الحاجز الأمني والاتصالات التجارية. توفر وينوو للإعلان كليهما."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تركب وينوو للإعلان لوحات المشاريع وأسوار البناء في جميع أنحاء الرياض، مع مشاريع تُنفذ على مستوى المدينة. يدير فريق التركيب لدينا الزيارة الميدانية الكاملة والتثبيت الهيكلي وجميع المعدات المطلوبة لتركيب كامل ومقاوم للطقس."
      }
    },
    {
      "@type": "Question",
