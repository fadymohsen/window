...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'دروع تذكارية وجوائز في الرياض | هدايا شركاتية السعودية | وينوو للإعلان',
            'meta_description' => 'دروع تذكارية وجوائز مخصصة للشركات في الرياض — وينوو للإعلان يصمم وينتج دروع التميز والألواح التكريمية لفعاليات التنظيم وتقدير الموظفين. دعاية واعلان الرياض والسعودية. احصل على عرض سعر.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>الدرع التذكاري أكثر من مجرد جائزة — إنه رمز دائم للتقدير يعرضه المُكرَّم ويصوره ويتذكره طويلاً بعد انتهاء الحفل. تصمم وينوو للإعلان وتصنع دروعاً تذكارية وجوائز شركاتية مخصصة لفعاليات تكريم الموظفين والمناسبات الحكومية والمؤسسات التعليمية وحفلات التقدير المؤسسية في جميع أنحاء الرياض والمملكة العربية السعودية.</p>
...
<p>كجزء من حل إعلاني وفعالياتي متكامل، تنتج وينوو للإعلان دروعاً تذكارية منسقة مع الهوية البصرية للحفل — تتوافق مع علامة الفعالية وتصميم المسرح والمواد المطبوعة لخلق تجربة تكريم موحدة. سواء كنت تنظم فعالية تقدير فريق صغير أو حفل جوائز وطني واسع النطاق، يجب أن يعكس الدرع نفسه مستوى المناسبة. دروعنا مكمّل طبيعي لمجموعتنا الأوسع من <a href="/ar/services/promotional-gifts">الهدايا الدعائية</a> للعملاء من الشركات.</p>

<h2>المواد والتشطيبات</h2>
<p>تعمل وينوو للإعلان بمواد فاخرة لإنتاج دروع مناسبة لكل مناسبة وميزانية:</p>
...
<p>كل درع تذكاري تنتجه وينوو للإعلان مخصص بشكل فردي للمُكرَّم والمناسبة. يشمل التخصيص شعار المؤسسة، والاسم الكامل واللقب للمُكرَّم، وفئة الجائزة، وتاريخ التقديم، وأي نص استشهاد مخصص أو خط عربي يطلبه العميل.</p>
...
<p>الدروع التذكارية عنصر محوري في حفلات التكريم الرسمية والحفلات السنوية وفعاليات تقدير الموظفين في جميع أنحاء الرياض. تنسق وينوو للإعلان إنتاج الدروع جنباً إلى جنب مع <a href="/ar/services/event-management">إدارة الفعاليات</a> الأوسع — لضمان جاهزية الجوائز قبل موعد الحفل، وتقديمها في تغليف فاخر، وتسليمها للمكان في الوقت المحدد.</p>
...
<p>الدرع التذكاري الفاخر يستحق تغليفاً فاخراً. توفر وينوو للإعلان الدروع التذكارية مع صناديق عرض مبطنة بالمخمل، وصناديق مطبوعة مخصصة تحمل علامة الفعالية أو المؤسسة، وحشوات إسفنجية واقية تثبت الدرع بأمان أثناء النقل والإهداء.</p>
...
<p>تصنع وينوو للإعلان الدروع التذكارية من الأكريليك والكريستال والفولاذ المقاوم للصدأ والألمنيوم والخشب الصلب والمواد المركبة من الخشب والمعدن. يعكس اختيار المادة مستوى فخامة المناسبة والجمالية المؤسسية للعلامة التجارية. الدروع الكريستالية والمعدنية هي الخيار الأكثر شيوعاً لجوائز تكريم كبار المدراء التنفيذيين والجوائز الحكومية.</p>

<h3>هل يمكن نقش رسالة مخصصة على الدرع؟</h3>
<p>نعم. كل درع تذكاري من وينوو للإعلان يتضمن نقشاً أو طباعة مخصصة باسم المُكرَّم ولقبه ومؤسسته وإنجازه وتاريخه. النصوص العربية والإنجليزية مدعومة. نقدم نموذجاً رقمياً لتخطيط النقش لموافقتك قبل بدء الإنتاج.</p>
...
<p>نعم. توفر وينوو للإعلان دروعاً تذكارية وجوائز تكريمية للمؤسسات الحكومية والشركات الخاصة والمنظمات التعليمية والمنظمات غير الربحية في جميع أنحاء الرياض والمملكة العربية السعودية. تستوعب تصاميمنا الخط العربي والشعارات المؤسسية ومعايير التقديم الرسمية المتوقعة في الحفلات السعودية الرسمية.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تصنع وينوو للإعلان الدروع التذكارية من الأكريليك والكريستال والفولاذ المقاوم للصدأ والألمنيوم والخشب الصلب والمواد المركبة من الخشب والمعدن. يعكس اختيار المادة مستوى فخامة المناسبة والجمالية المؤسسية للعلامة التجارية. الدروع الكريستالية والمعدنية هي الخيار الأكثر شيوعاً لجوائز تكريم كبار المدراء التنفيذيين والجوائز الحكومية."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. كل درع تذكاري من وينوو للإعلان يتضمن نقشاً أو طباعة مخصصة باسم المُكرَّم ولقبه ومؤسسته وإنجازه وتاريخه. النصوص العربية والإنجليزية مدعومة. نقدم نموذجاً رقمياً لتخطيط النقش لموافقتك قبل بدء الإنتاج."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. توفر وينوو للإعلان دروعاً تذكارية وجوائز تكريمية للمؤسسات الحكومية والشركات الخاصة والمنظمات التعليمية والمنظمات غير الربحية في جميع أنحاء الرياض والمملكة العربية السعودية. تستوعب تصاميمنا الخط العربي والشعارات المؤسسية ومعايير التقديم الرسمية المتوقعة في الحفلات السعودية الرسمية."
      }
    }
  ]
}
