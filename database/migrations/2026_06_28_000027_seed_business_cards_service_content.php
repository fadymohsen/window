...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'بطاقات أعمال في الرياض | طباعة كروت الشركة السعودية | ويندو للإعلان',
            'meta_description' => 'تصميم وطباعة بطاقات أعمال احترافية في الرياض — ويندو للإعلان يصمم ويطبع بطاقات أعمال مخصصة وفاخرة لشركات في السعودية. تصميم هوية وطباعة شركاتية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>تصمم ويندو للإعلان بطاقات الأعمال كجزء من نظام <a href="/ar/services/corporate-visual-identity-design">تصميم الهوية البصرية المؤسسية</a> الكامل الذي نطوره للعملاء، مما يضمن أن البطاقة لا تُصمم بمعزل بل كعنصر واحد من مجموعة قرطاسية مؤسسية منسقة — إلى جانب <a href="/ar/services/profile-design-printing">تصميم وطباعة البروفايل</a> والمواد المؤسسية الأخرى.</p>

<h2>أنواع الورق وخيارات الطباعة</h2>
<p>تُنقل جودة بطاقة الأعمال من خلال وزن الورق وتشطيبه بقدر ما تُنقل من خلال التصميم نفسه. تطبع ويندو للإعلان بطاقات الأعمال على مجموعة شاملة من أنواع الورق كجزء من عروض <a href="/ar/services/business-prints">المطبوعات التجارية</a> الكاملة:</p>
...
<p>التشطيب الفاخر يرتقي ببطاقة الأعمال من طباعة قياسية إلى بيان ملموس للعلامة التجارية. تقدم ويندو للإعلان:</p>
...
<p>في بيئة الأعمال السعودية ثنائية اللغة، يحتاج كثير من المحترفين إلى بطاقات أعمال بالعربية والإنجليزية. تصمم ويندو للإعلان بطاقات أعمال ثنائية اللغة بكلتا اللغتين على نفس البطاقة (العربية على جهة والإنجليزية على الأخرى)، أو كبطاقات ثنائية اللغة بكلتا اللغتين على الوجه الأمامي.</p>
...
<p>للشركات التي تطلب بطاقات أعمال لفريق عمل، تدير ويندو للإعلان سير العمل الإنتاجي الكامل — جمع معلومات الأسماء والمسميات الوظيفية، وتطبيق القالب المعتمد على كل بطاقة، وإنتاج مجموعة بروفات رقمية للموافقة، وتسليم علب بطاقات فردية مُعنونة لكل عضو في الفريق. تتوفر أسعار حسابات الشركات للشركات التي تطلب 500 بطاقة أعمال أو أكثر عبر أسماء متعددة.</p>

<h2>الأسئلة الشائعة حول بطاقات الأعمال</h2>

<h3>ما التشطيبات الفاخرة المتوفرة لبطاقات الأعمال في الرياض؟</h3>
<p>تقدم ويندو للإعلان بطاقات أعمال بتغليف مطفي ناعم الملمس، وتغليف لامع عالي اللمعان، وطلاء UV موضعي على الشعارات وعناصر التصميم، وطباعة بالرقائق المعدنية بالذهبي والفضي والوردي الذهبي، وطلاء UV بارز (ثلاثي الأبعاد)، وحفر بالطباعة البارزة، وطلاء الحواف. التشطيبات الفاخرة متوفرة على أوراق البطاقات القياسية والسميكة بما في ذلك خيارات 400 و600 جرام.</p>

<h3>هل يمكنكم تصميم بطاقة الأعمال بالإضافة إلى طباعتها؟</h3>
<p>نعم. تقدم ويندو للإعلان خدمات تصميم كاملة لبطاقات الأعمال. يبتكر فريق التصميم لدينا تخطيطات بطاقات أعمال تلتزم بإرشادات هويتك المؤسسية — أو يطور تصميم بطاقة أعمال جديداً من الصفر كجزء من مشروع هوية مؤسسية أوسع. بطاقات أعمال ثنائية اللغة عربي-إنجليزي متوفرة بكلتا اللغتين على نفس البطاقة أو على وجهين منفصلين.</p>

<h3>ما المقاس القياسي لبطاقة الأعمال في السعودية؟</h3>
<p>المقاس القياسي لبطاقة الأعمال في المملكة العربية السعودية هو 85 مم في 55 مم — نفس المعيار الدولي المستخدم في معظم أنحاء العالم. تنتج ويندو للإعلان أيضاً بطاقات مربعة وبطاقات مطوية وبطاقات بمقاسات مخصصة للعملاء الذين يريدون شكلاً مميزاً يبرز عن المقاس القياسي.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تقدم ويندو للإعلان بطاقات أعمال بتغليف مطفي ناعم الملمس، وتغليف لامع عالي اللمعان، وطلاء UV موضعي على الشعارات وعناصر التصميم، وطباعة بالرقائق المعدنية بالذهبي والفضي والوردي الذهبي، وطلاء UV بارز (ثلاثي الأبعاد)، وحفر بالطباعة البارزة، وطلاء الحواف. التشطيبات الفاخرة متوفرة على أوراق البطاقات القياسية والسميكة بما في ذلك خيارات 400 و600 جرام."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تقدم ويندو للإعلان خدمات تصميم كاملة لبطاقات الأعمال. يبتكر فريق التصميم لدينا تخطيطات بطاقات أعمال تلتزم بإرشادات هويتك المؤسسية — أو يطور تصميم بطاقة أعمال جديداً من الصفر كجزء من مشروع هوية مؤسسية أوسع. بطاقات أعمال ثنائية اللغة عربي-إنجليزي متوفرة بكلتا اللغتين على نفس البطاقة أو على وجهين منفصلين."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "المقاس القياسي لبطاقة الأعمال في المملكة العربية السعودية هو 85 مم في 55 مم — نفس المعيار الدولي المستخدم في معظم أنحاء العالم. تنتج ويندو للإعلان أيضاً بطاقات مربعة وبطاقات مطوية وبطاقات بمقاسات مخصصة للعملاء الذين يريدون شكلاً مميزاً يبرز عن المقاس القياسي."
      }
    },
    {
      "@type": "Question",
