...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'ملفات PVC مع مشبك في الرياض | ملفات وثائق مخصصة السعودية | وينوو للإعلان',
            'meta_description' => 'تصنيع ملفات PVC مع مشبك وملفات وثائق مخصصة في الرياض — وينوو للإعلان يصنع ملفات PVC وكلبسات وثائق وأكواد مخصصة للشركات في السعودية. دعاية واعلان الرياض وهدايا دعائية. احصل على عرض سعر.',
...
<p>تستخدم الجهات الحكومية ومكاتب المحاماة ومنظمات الرعاية الصحية وشركات الخدمات المالية والمكاتب المؤسسية في جميع أنحاء الرياض ملفات PVC المؤسسية كجزء من طقم القرطاسية القياسي. تصنّع وينوو للإعلان ملفات PVC تتطابق مع الهوية المؤسسية للمنظمة — الشعار والألوان واللغة البصرية المتسقة مع نظام القرطاسية الكامل، بما في ذلك <a href="/ar/services/profile-design-printing">تصميم وطباعة البروفايل</a>.</p>

<h2>أنواع ومواصفات ملفات PVC</h2>
<p>تصنّع وينوو للإعلان ملفات PVC وحوافظ وثائق بمجموعة متنوعة من المواصفات:</p>
...
<p>تنتج وينوو للإعلان أطقم هدايا ملفات PVC الدعائية المنسقة مع عناصر قرطاسية مؤسسية أخرى — الدفاتر والأقلام ومحركات USB و<a href="/ar/services/business-cards">بطاقات الأعمال</a> — كأطقم هدايا موحدة.</p>

<h2>ملفات PVC للبيئات الطبية والصحية</h2>
<p>تستخدم البيئات الصحية في جميع أنحاء الرياض ملفات PVC مع مشبك على نطاق واسع لتوثيق المرضى وإدارة السجلات الطبية والإدارة السريرية. تصنّع وينوو للإعلان ملفات PVC بدرجة طبية بأسطح سهلة التنظيف ومشابك زنبركية متينة مصممة للاستخدام اليومي المكثف وعلامة تجارية مناسبة للمنظمة الطبية أو الصحية. اطلع أيضاً على خدمة <a href="/ar/services/medical-files">الملفات الطبية</a> المخصصة لدينا.</p>
...
<h3>ما أنواع ملفات PVC التي تصنعها وينوو للإعلان؟</h3>
<p>تصنّع وينوو للإعلان ملفات PVC الصلبة مع مشابك معدنية زنبركية (النوع القياسي المستخدم في البيئات المؤسسية والطبية في المملكة العربية السعودية)، وملفات PVC المرنة مع إغلاق فيلكرو أو سحاب، وملفات وثائق بمقاس A4 وفولسكاب مع جيب أمامي ومشبك، وملفات PVC بأحجام مخصصة وفق متطلبات المشروع، وملفات تنظيم وثائق متعددة الأقسام. جميع الأنواع متوفرة بطباعة خارجية كاملة الألوان أو طباعة شعار بالشاشة الحريرية.</p>
...
<p>الحد الأدنى لطلب ملفات PVC المطبوعة بالشاشة الحريرية هو عادة 100 وحدة. لملفات البطاقات الداخلية المطبوعة رقمياً بالألوان الكاملة، الحد الأدنى هو 50 وحدة. ملفات PVC المصنعة حسب الطلب بأبعاد أو متطلبات أدوات محددة تتطلب عادة حداً أدنى من 200 إلى 500 وحدة. تواصل مع وينوو للإعلان لأسعار الكميات المحددة.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع ملفات PVC التي تصنعها وينوو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تصنّع وينوو للإعلان ملفات PVC الصلبة مع مشابك معدنية زنبركية (النوع القياسي المستخدم في البيئات المؤسسية والطبية في المملكة العربية السعودية)، وملفات PVC المرنة مع إغلاق فيلكرو أو سحاب، وملفات وثائق بمقاس A4 وفولسكاب مع جيب أمامي ومشبك، وملفات PVC بأحجام مخصصة وفق متطلبات المشروع، وملفات تنظيم وثائق متعددة الأقسام. جميع الأنواع متوفرة بطباعة خارجية كاملة الألوان أو طباعة شعار بالشاشة الحريرية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "الحد الأدنى لطلب ملفات PVC المطبوعة بالشاشة الحريرية هو عادة 100 وحدة. لملفات البطاقات الداخلية المطبوعة رقمياً بالألوان الكاملة، الحد الأدنى هو 50 وحدة. ملفات PVC المصنعة حسب الطلب بأبعاد أو متطلبات أدوات محددة تتطلب عادة حداً أدنى من 200 إلى 500 وحدة. تواصل مع وينوو للإعلان لأسعار الكميات المحددة."
      }
    }
  ]
}
