...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'يونيفورم وزي موحد في الرياض | ويندو للإعلان',
            'meta_description' => 'تصميم وتوريد يونيفورم وزي موحد مخصص للشركات في الرياض — ويندو للإعلان يوفر حلول دعاية واعلان متكاملة تشمل تصميم هوية الموظفين والزي الموحد للشركات السعودية. احصل على عرض سعر.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>الزي الموحد الاحترافي هو أحد أبرز التعبيرات المرئية عن هوية شركتك. تقوم ويندو للإعلان بتصميم وتوريد يونيفورم مخصص للشركات في جميع أنحاء الرياض والمملكة العربية السعودية — كجزء من حل متكامل للدعاية والإعلان وتصميم الهوية يمتد من المطبوعات واللافتات إلى المظهر اليومي لموظفيك.</p>
...
<p>تحدد التقنية المستخدمة لتطبيق شعارك على الزي الموحد مظهره ومدة بقائه عبر الغسيل والارتداء اليومي. تستخدم ويندو للإعلان ثلاث طرق رئيسية:</p>
...
<p>للفعاليات والمناسبات المؤسسية، توزع التيشيرتات وقمصان البولو التي تحمل العلامة التجارية أيضاً كـ<a href="/ar/services/promotional-gifts">هدايا دعائية</a> وعناصر تقدير للفريق. تنسق ويندو للإعلان إنتاج الزي الموحد إلى جانب حملات الهدايا الترويجية والدعاية والإعلان الأوسع — بما في ذلك <a href="/ar/services/scarf-printing">طباعة الأوشحة</a> و<a href="/ar/services/employee-gift-boxes">صناديق هدايا الموظفين</a> — للشركات التي تريد مظهراً موحداً عبر كل نقطة اتصال تحمل العلامة التجارية.</p>

<h2>خيارات المقاسات للعملاء الشركاتيين السعوديين</h2>
<p>توفر ويندو للإعلان الزي الموحد بمجموعة كاملة من المقاسات لاستيعاب القوى العاملة السعودية المتنوعة. نقدم مقاسات دولية قياسية بالإضافة إلى تفصيل مخصص للإدارة العليا وموظفي الفعاليات المهمين حيث يُطلب مظهر مضبوط بدقة.</p>
...
<p>تمتد محفظة أعمالنا في الزي الموحد عبر مجموعات الضيافة والفرق المؤسسية وموظفي الفعاليات وسلاسل التجزئة ومقدمي الرعاية الصحية في جميع أنحاء الرياض. تصفح المعرض لرؤية مجموعة ملابس العمل التي تحمل العلامة التجارية والمنتجة والمسلمة من ويندو للإعلان.</p>

<h2>الأسئلة الشائعة حول الزي الموحد للشركات</h2>

<h3>ما أنواع الزي الموحد الذي توفره ويندو للإعلان في الرياض؟</h3>
<p>توفر ويندو للإعلان مجموعة كاملة من الزي الموحد للشركات والموظفين تشمل قمصان البولو والقمصان الرسمية والتيشيرتات وسترات السلامة ويونيفورم الضيافة وسترات الطهاة والأزياء الطبية ويونيفورم الأمن وملابس موظفي الفعاليات. جميع الملابس متوفرة مع التطريز أو الطباعة بالشاشة الحريرية أو النقل الحراري للعلامة التجارية.</p>

<h3>هل يمكنكم إضافة شعار شركتنا على الزي الموحد؟</h3>
<p>نعم. كل زي موحد توفره ويندو للإعلان يحمل شعار شركتك باستخدام التقنية الأنسب لنوع القماش والملابس. التطريز هو اللمسة النهائية المفضلة لقمصان البولو والقمصان الرسمية. الطباعة بالشاشة الحريرية هي المعيار للتيشيرتات وملابس الفعاليات. النقل الحراري يُستخدم للتصميمات المعقدة متعددة الألوان.</p>

<h3>ما الحد الأدنى لطلب الزي الموحد للشركات؟</h3>
<p>تختلف الحدود الدنيا للطلب حسب نوع الملابس، وتبدأ عادةً من 12 إلى 50 قطعة لكل نمط. تتولى ويندو للإعلان طلبات الزي الموحد للفرق الصغيرة وكذلك عمليات التوزيع المؤسسية الكبيرة التي تتطلب مئات أو آلاف القطع عبر مدن سعودية متعددة.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع الزي الموحد الذي توفره ويندو للإعلان في الرياض؟",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. كل زي موحد توفره ويندو للإعلان يحمل شعار شركتك باستخدام التقنية الأنسب لنوع القماش والملابس. التطريز هو اللمسة النهائية المفضلة لقمصان البولو والقمصان الرسمية. الطباعة بالشاشة الحريرية هي المعيار للتيشيرتات وملابس الفعاليات. النقل الحراري يُستخدم للتصميمات المعقدة متعددة الألوان."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تختلف الحدود الدنيا للطلب حسب نوع الملابس، وتبدأ عادةً من 12 إلى 50 قطعة لكل نمط. تتولى ويندو للإعلان طلبات الزي الموحد للفرق الصغيرة وكذلك عمليات التوزيع المؤسسية الكبيرة التي تتطلب مئات أو آلاف القطع عبر مدن سعودية متعددة."
      }
    },
    {
      "@type": "Question",
