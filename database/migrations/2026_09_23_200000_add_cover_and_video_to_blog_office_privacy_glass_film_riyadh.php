...
{
    private string $slug = 'office-privacy-glass-film-riyadh';
    private string $coverPath = 'blogs/covers/office-privacy-glass-film-riyadh.webp';
...
HTML;
    ...
    public function down(): void
    {
        ...
        if ($blog->cover === $this->coverPath) {
            DB::table('blogs')->where('id', $blog->id)->update(['cover' => 'blogs/covers/placeholder-office-privacy-glass-film-riyadh.webp']);
        }
    ...
    {
        $source = base_path('resources/blog-assets/office-privacy-glass-film-riyadh-window.jpeg');
        if (!is_file($source)) {
            return;
        }
    ...
    private function insertVideoAfterFirstParagraph(int $blogId, string $locale): void
    {
        ...
        if (!$translation || str_contains($translation->description, 'youtube.com/embed/CK7Zn7yVg8Q')) {
            return;
        }
