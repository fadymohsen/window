...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'مطبوعات تجارية في الرياض | تصميم بروفيل وكتالوج وتقرير | وينوو للإعلان',
            'meta_description' => 'مطبوعات تجارية احترافية في الرياض — تصميم بروفيل الشركة، تصميم كتالوج، تصميم تقرير سنوي، وتصميم مواد تسويقية. وينوو للإعلان للدعاية والإعلان في السعودية. احصل على عرض سعر مجاني.',
...
<p>تصمم وينوو للإعلان وتطبع كتالوجات المنتجات للشركات التجارية والمصنعين وشركات البناء ومقدمي الخدمات في جميع أنحاء المملكة العربية السعودية. تشمل خدمة تصميم الكتالوج لدينا تخطيط تصوير المنتجات، وتكامل قوائم الأسعار، وهيكل الفئات، والنص ثنائي اللغة — يُسلَّم بتنسيق جاهز للطباعة ويُطبع بالكمية المطلوبة.</p>
...
<p>تصمم وينوو للإعلان التقارير السنوية والتقارير الشركاتية للشركات في الرياض، وتتولى كل شيء من تصميم الإنفوجرافيك وتصور البيانات إلى الإنتاج النهائي للطباعة. تُنتج النسختان العربية والإنجليزية بنفس معيار التصميم، مع توفر تخطيطات ثنائية اللغة حسب الحاجة.</p>

<h2>البروشورات والفلايرز والمواد التسويقية</h2>
<p>إلى جانب الوثائق المؤسسية الرئيسية، تعتمد الشركات في الرياض على إمداد مستمر من المواد التسويقية المطبوعة للحملات والفعاليات والتواصل مع العملاء. تنتج وينوو للإعلان المجموعة الكاملة:</p>
...
<p>تشطيب الوثيقة المطبوعة هو ما يفصل الطباعة العادية عن الأصول المؤسسية الفاخرة. تقدم وينوو للإعلان قائمة كاملة من تشطيبات الطباعة عبر إنتاجنا الداخلي وشركائنا:</p>
...
<h3>ما خدمات المطبوعات التجارية التي تقدمها وينوو للإعلان؟</h3>
<p>تصمم وينوو للإعلان وتطبع مجموعة كاملة من الوثائق المؤسسية: بروفيلات الشركات، وكتالوجات المنتجات والخدمات، والتقارير السنوية، والبروشورات، والفلايرات، ومجلدات العروض التقديمية، وبطاقات الأعمال، والأوراق الرسمية، والمواد التسويقية. تتوفر خدمات التصميم فقط أو التصميم والطباعة معاً.</p>

<h3>هل تستطيع وينوو للإعلان تصميم بروفيل شركتنا من الصفر؟</h3>
...
<p>نعم. جميع وثائق المطبوعات التجارية من وينوو للإعلان متوفرة بتنسيق ثنائي اللغة عربية-إنجليزية، أو عربية فقط، أو إنجليزية فقط. فريق التصميم لدينا متمرس في التعامل مع الطباعة العربية من اليمين إلى اليسار جنباً إلى جنب مع الإنجليزية من اليسار إلى اليمين في نفس الوثيقة.</p>

<h3>ما تشطيبات الطباعة المتوفرة للوثائق التجارية؟</h3>
<p>تقدم وينوو للإعلان تشطيبات طباعة فاخرة تشمل التغليف اللامع، والتغليف غير اللامع، والطلاء الناعم، والأشعة فوق البنفسجية الموضعية، والنقش البارز، والنقش الغائر، وختم الرقائق. ترتقي هذه التشطيبات بجودة وقيمة الوثائق المؤسسية مثل بروفيلات الشركات والتقارير السنوية.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما خدمات المطبوعات التجارية التي تقدمها وينوو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تصمم وينوو للإعلان وتطبع مجموعة كاملة من الوثائق المؤسسية: بروفيلات الشركات، وكتالوجات المنتجات والخدمات، والتقارير السنوية، والبروشورات، والفلايرات، ومجلدات العروض التقديمية، وبطاقات الأعمال، والأوراق الرسمية، والمواد التسويقية. تتوفر خدمات التصميم فقط أو التصميم والطباعة معاً."
      }
    },
    {
      "@type": "Question",
      "name": "هل تستطيع وينوو للإعلان تصميم بروفيل شركتنا من الصفر؟",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. جميع وثائق المطبوعات التجارية من وينوو للإعلان متوفرة بتنسيق ثنائي اللغة عربية-إنجليزية، أو عربية فقط، أو إنجليزية فقط. فريق التصميم لدينا متمرس في التعامل مع الطباعة العربية من اليمين إلى اليسار جنباً إلى جنب مع الإنجليزية من اليسار إلى اليمين في نفس الوثيقة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تقدم وينوو للإعلان تشطيبات طباعة فاخرة تشمل التغليف اللامع، والتغليف غير اللامع، والطلاء الناعم، والأشعة فوق البنفسجية الموضعية، والنقش البارز، والنقش الغائر، وختم الرقائق. ترتقي هذه التشطيبات بجودة وقيمة الوثائق المؤسسية مثل بروفيلات الشركات والتقارير السنوية."
      }
    },
    {
      "@type": "Question",
