...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'طباعة وتركيب البنرات في الرياض | ويندو للإعلان',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>البنرات هي أكثر أدوات الإعلان كبيرة الحجم مرونة وفعالية من حيث التكلفة في السوق السعودي. سواء كنت بحاجة إلى <a href="/ar/services/backdrop">خلفية</a> لفعالية داخلية، أو بنر إعلاني خارجي يمتد عبر الشارع، أو طباعة واجهة مبنى كاملة، تقوم ويندو للإعلان بطباعة وتركيب البنرات بجميع الأشكال والأحجام في جميع أنحاء الرياض والمملكة. من <a href="/ar/services/roll-up">ستاندات الرول أب</a> إلى أغلفة السقالات الضخمة، نتولى كل خطوة من التصميم إلى التركيب.</p>
...
<p>تنقل البنرات علامتك التجارية عبر واجهات الطرق ومواقع البناء وأماكن الفعاليات وبيئات البيع بالتجزئة والأماكن العامة. على عكس الإعلان الرقمي، يعمل البنر الخارجي الموضوع بشكل جيد 24 ساعة في اليوم، 7 أيام في الأسبوع، دون تكلفة متكررة. تقوم ويندو للإعلان بإنتاج البنرات للحملات الإعلانية والفعاليات وإطلاق المتاجر والمشاريع المؤسسية في جميع أنحاء الرياض منذ تأسيس الشركة.</p>

<h2>أنواع البنرات التي نطبعها ونركبها</h2>
<p>تنتج ويندو للإعلان كل أشكال البنرات الإعلانية المستخدمة في السوق السعودي:</p>
...
<p>تشغّل ويندو للإعلان معدات طباعة رقمية كبيرة الحجم قادرة على إنتاج بنرات بأي أبعاد تتطلبها الحملة. يتعامل عرض الطباعة القياسي لدينا مع ما يصل إلى 5 أمتار في تمريرة واحدة. للبنرات الأعرض من ذلك، ننتج وصلات سلسة باستخدام محاذاة دقيقة غير مرئية على مسافات المشاهدة العادية.</p>
...
<p>طباعة البنر هي نصف الخدمة فقط. التركيب الاحترافي يضمن تثبيت البنر بأمان وشده بشكل صحيح ووضعه لتحقيق أقصى قدر من الرؤية. توفر ويندو للإعلان خدمات تركيب كاملة في جميع أنحاء الرياض لكل أشكال البنرات.</p>
...
<p>يعتمد منظمو الفعاليات في جميع أنحاء الرياض على ويندو للإعلان لإنتاج وتركيب بنرات سريعة وعالية الجودة منسقة مع الجدول الزمني لفعالياتهم. ننتج بنرات لـ<a href="/ar/services/national-day-celebrations">احتفالات اليوم الوطني</a> وفعاليات يوم التأسيس وحملات إطلاق المنتجات وقاعات المعارض والفعاليات الرياضية والمهرجانات الخارجية.</p>
...
<p>تتضمن محفظة أعمالنا في طباعة وتركيب البنرات حملات إعلانية خارجية وتركيبات فعاليات وبنرات إطلاق متاجر وبنرات سقالات مواقع البناء في جميع أنحاء الرياض والمملكة العربية السعودية. تصفح المعرض أدناه لمشاهدة حجم ونطاق الأعمال المنجزة من ويندو للإعلان.</p>

<h2>الأسئلة الشائعة حول طباعة البنرات</h2>

<h3>ما المواد التي تستخدمها ويندو للإعلان لطباعة البنرات الخارجية؟</h3>
<p>تطبع ويندو للإعلان البنرات الخارجية على مواد PVC فلكس وقماش بنر شبكي وفيلم إضاءة خلفية حسب التطبيق. تستخدم جميع المواد الخارجية أحبار مذيبة مقاومة للأشعة فوق البنفسجية تحافظ على حيوية الألوان في ظروف الرياض الخارجية ذات الحرارة العالية. تُعزز مواد البنر القياسية بحواف مطوية وثقوب معدنية للتثبيت الآمن.</p>

<h3>ما أحجام البنرات التي يمكن لويندو للإعلان طباعتها؟</h3>
<p>تطبع ويندو للإعلان بنرات بأي حجم من لافتات الفعاليات الصغيرة إلى بنرات الإعلان الخارجي الكبيرة جداً. تتعامل معدات الطباعة كبيرة الحجم لدينا مع عروض تصل إلى 5 أمتار. للتركيبات الأكبر، تُطبع اللوحات على أقسام وتُوصل معاً في الموقع. تواصل معنا بالأبعاد المطلوبة للحصول على عرض سعر محدد.</p>

<h3>هل تتولى ويندو للإعلان الطباعة والتركيب معاً؟</h3>
<p>نعم. توفر ويندو للإعلان خدمة توريد وتركيب كاملة. يتولى فريق التركيب لدينا أجهزة التثبيت والتعليق وتنسيق السقالات والتركيب الفعلي في موقعك في جميع أنحاء الرياض والمملكة العربية السعودية. تحصل على بنر مركب جاهز دون إدارة مقاولين منفصلين.</p>
...
<p>نعم. تنتج ويندو للإعلان بنرات إعلانية خارجية للتركيب في الشوارع وواجهات المباني والأسوار والسقالات ومحيطات الفعاليات في جميع أنحاء الرياض. نستخدم مواد وطرق تشطيب تتحمل مناخ الرياض الخارجي، بما في ذلك خيارات الشبك المقاوم للرياح للمواقع المكشوفة.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما المواد التي تستخدمها ويندو للإعلان لطباعة البنرات الخارجية؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تطبع ويندو للإعلان البنرات الخارجية على مواد PVC فلكس وقماش بنر شبكي وفيلم إضاءة خلفية حسب التطبيق. تستخدم جميع المواد الخارجية أحبار مذيبة مقاومة للأشعة فوق البنفسجية تحافظ على حيوية الألوان في ظروف الرياض الخارجية ذات الحرارة العالية. تُعزز مواد البنر القياسية بحواف مطوية وثقوب معدنية للتثبيت الآمن."
      }
    },
    {
      "@type": "Question",
      "name": "ما أحجام البنرات التي يمكن لويندو للإعلان طباعتها؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تطبع ويندو للإعلان بنرات بأي حجم من لافتات الفعاليات الصغيرة إلى بنرات الإعلان الخارجي الكبيرة جداً. تتعامل معدات الطباعة كبيرة الحجم لدينا مع عروض تصل إلى 5 أمتار. للتركيبات الأكبر، تُطبع اللوحات على أقسام وتُوصل معاً في الموقع. تواصل معنا بالأبعاد المطلوبة للحصول على عرض سعر محدد."
      }
    },
    {
      "@type": "Question",
      "name": "هل تتولى ويندو للإعلان الطباعة والتركيب معاً؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. توفر ويندو للإعلان خدمة توريد وتركيب كاملة. يتولى فريق التركيب لدينا أجهزة التثبيت والتعليق وتنسيق السقالات والتركيب الفعلي في موقعك في جميع أنحاء الرياض والمملكة العربية السعودية. تحصل على بنر مركب جاهز دون إدارة مقاولين منفصلين."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تنتج ويندو للإعلان بنرات إعلانية خارجية للتركيب في الشوارع وواجهات المباني والأسوار والسقالات ومحيطات الفعاليات في جميع أنحاء الرياض. نستخدم مواد وطرق تشطيب تتحمل مناخ الرياض الخارجي، بما في ذلك خيارات الشبك المقاوم للرياح للمواقع المكشوفة."
      }
    }
  ]
}
