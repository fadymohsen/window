...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تنظيم الفعاليات والمؤتمرات في الرياض | ويندو للإعلان',
...
<p>نظمت ويندو للإعلان فعاليات تتراوح من ورش عمل لـ 50 شخصاً إلى مؤتمرات عامة بآلاف الحضور. يقدم فريقنا نفس الانضباط لكل صيغة.</p>
...
<p>تقدم ويندو للإعلان كل عنصر إنتاجي مطلوب لمؤتمر عالمي المستوى:</p>
...
<p>تتضمن باقة تنظيم المؤتمرات الكاملة من ويندو للإعلان تنسيق المكان، وتصميم المسرح والمنصة، وطباعة الخلفيات المؤسسية، وإعداد مكتب التسجيل، واللافتات الإرشادية، وتنسيق الصوت والإضاءة، والقرطاسية المؤسسية، وصناديق هدايا الحضور، وفريق إدارة كامل في الموقع.</p>

<h3>كم تكلفة تنظيم مؤتمر في الرياض؟</h3>
<p>تختلف تكاليف تنظيم المؤتمرات في الرياض بناءً على عدد الحضور ومتطلبات المكان ونطاق العلامة التجارية والمدة. تقدم ويندو للإعلان باقات قابلة للتوسع لتناسب جميع الميزانيات. تواصل معنا بملخص فعاليتك للحصول على عرض سعر مفصل ومجاني.</p>

<h3>هل تتولى ويندو للإعلان العلامة التجارية والمواد المطبوعة لمؤتمرنا؟</h3>
...
<p>نعم. بالإضافة إلى المؤتمرات الداخلية، تنظم ويندو للإعلان فعاليات خارجية ومهرجانات وفعاليات عامة. نتولى الهياكل المقاومة للطقس والعلامة التجارية الخارجية وتخطيط إدارة الحشود والإنتاج الكامل للبيئات الخارجية.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تتضمن باقة تنظيم المؤتمرات الكاملة من ويندو للإعلان تنسيق المكان، وتصميم المسرح والمنصة، وطباعة الخلفيات المؤسسية، وإعداد مكتب التسجيل، واللافتات الإرشادية، وتنسيق الصوت والإضاءة، والقرطاسية المؤسسية، وصناديق هدايا الحضور، وفريق إدارة كامل في الموقع."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تختلف تكاليف تنظيم المؤتمرات في الرياض بناءً على عدد الحضور ومتطلبات المكان ونطاق العلامة التجارية والمدة. تقدم ويندو للإعلان باقات قابلة للتوسع لتناسب جميع الميزانيات. تواصل معنا بملخص فعاليتك للحصول على عرض سعر مفصل ومجاني."
      }
    },
    {
      "@type": "Question",
      "name": "هل تتولى ويندو للإعلان العلامة التجارية والمواد المطبوعة لمؤتمرنا؟",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. بالإضافة إلى المؤتمرات الداخلية، تنظم ويندو للإعلان فعاليات خارجية ومهرجانات وفعاليات عامة. نتولى الهياكل المقاومة للطقس والعلامة التجارية الخارجية وتخطيط إدارة الحشود والإنتاج الكامل للبيئات الخارجية."
      }
    }
  ]
}
