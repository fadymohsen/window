...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تصميم وطباعة تيشيرت في الرياض | تيشيرتات مخصصة السعودية | ويندو للإعلان',
            'meta_description' => 'تصميم وطباعة تيشيرتات مخصصة في الرياض — ويندو للإعلان يصمم ويطبع تيشيرتات مميزة للفعاليات الشركاتية والهدايا الترويجية وزي الفريق. دعاية واعلان الرياض والسعودية. احصل على عرض سعر.',
...
<p>تستخدم ويندو للإعلان طريقة الطباعة الأنسب لكمية كل طلب وتصميمه ومتطلبات جودته:</p>
...
<p>تصميم التيشيرت الفعال يوازن بين التأثير البصري وقابلية الطباعة — يجب أن يبدو التصميم على القماش بنفس جودة مظهره على الشاشة. فريق التصميم في ويندو للإعلان لديه خبرة واسعة في إنتاج رسومات تيشيرتات تُترجم بشكل صحيح من الملف الرقمي إلى الملابس المطبوعة.</p>
...
<p>تستخدم ويندو للإعلان الطباعة بالشاشة الحريرية للكميات الكبيرة من 50 وحدة فأكثر بـ 1 إلى 4 ألوان، والفينيل الحراري للكميات الأصغر والتصاميم متعددة الألوان، والطباعة المباشرة على الملابس (DTG) للتصاميم الفوتوغرافية كاملة الألوان والكميات الصغيرة جداً. نوصي بأفضل طريقة لكل طلب بناءً على الكمية وتعقيد التصميم ونوع القماش.</p>

<h3>ما الحد الأدنى لطلب التيشيرتات المطبوعة؟</h3>
<p>تقبل ويندو للإعلان طلبات التيشيرتات من حد أدنى 12 وحدة للفينيل الحراري والطباعة المباشرة. الطباعة بالشاشة لها حد أدنى 50 وحدة بسبب تكلفة إعداد الشاشة. لإنتاج وحدة واحدة أو عينة قبل طلب أكبر، الطباعة المباشرة متاحة للقطع الفردية.</p>

<h3>هل يمكنكم تصميم رسومات التيشيرت بالإضافة إلى طباعتها؟</h3>
<p>نعم. تقدم ويندو للإعلان خدمات تصميم تيشيرت كاملة بالإضافة إلى الطباعة. فريق التصميم لدينا يبتكر رسومات من ملخصك — سواء كان وضع شعار بسيط أو رسم توضيحي خاص بفعالية أو شعار تحفيزي أو تصميم مطبوع كامل للأمام والخلف. يتم تقديم نموذج رقمي على لون الملابس الذي تختاره للموافقة عليه قبل الطباعة.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تستخدم ويندو للإعلان الطباعة بالشاشة الحريرية للكميات الكبيرة من 50 وحدة فأكثر بـ 1 إلى 4 ألوان، والفينيل الحراري للكميات الأصغر والتصاميم متعددة الألوان، والطباعة المباشرة على الملابس (DTG) للتصاميم الفوتوغرافية كاملة الألوان والكميات الصغيرة جداً. نوصي بأفضل طريقة لكل طلب بناءً على الكمية وتعقيد التصميم ونوع القماش."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تقبل ويندو للإعلان طلبات التيشيرتات من حد أدنى 12 وحدة للفينيل الحراري والطباعة المباشرة. الطباعة بالشاشة لها حد أدنى 50 وحدة بسبب تكلفة إعداد الشاشة. لإنتاج وحدة واحدة أو عينة قبل طلب أكبر، الطباعة المباشرة متاحة للقطع الفردية."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تقدم ويندو للإعلان خدمات تصميم تيشيرت كاملة بالإضافة إلى الطباعة. فريق التصميم لدينا يبتكر رسومات من ملخصك — سواء كان وضع شعار بسيط أو رسم توضيحي خاص بفعالية أو شعار تحفيزي أو تصميم مطبوع كامل للأمام والخلف. يتم تقديم نموذج رقمي على لون الملابس الذي تختاره للموافقة عليه قبل الطباعة."
      }
    },
    {
      "@type": "Question",
