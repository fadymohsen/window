...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'استيكرات حوائط في الرياض | جرافيك جدران فينيل السعودية | ويندو للإعلان',
            'meta_description' => 'استيكرات حوائط وجرافيك جدران مخصص في الرياض — ويندو للإعلان يصمم ويثبت استيكرات جدران مميزة للمكاتب والمتاجر والفنادق والفعاليات. دعاية واعلان الرياض والسعودية. احصل على عرض سعر.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>تحول استيكرات الحوائط وجرافيك الجدران الفينيل الأسطح الفارغة إلى أصول إعلانية مؤسسية تعمل على مدار الساعة. في المكاتب والمتاجر والفنادق والفعاليات في جميع أنحاء الرياض، تنقل جرافيك الجدران قيم الشركة، وتعزز الهوية البصرية، وتوجه الزوار عبر المساحات، وتخلق بيئات تعكس طابع المؤسسة. ويندو للإعلان يصمم ويثبت استيكرات حوائط مخصصة للشركات في جميع أنحاء المملكة العربية السعودية — كجزء من حل متكامل للدعاية والإعلان وتصميم الهوية.</p>
...
<p>تنتج ويندو للإعلان تطبيقات جرافيك الجدران عبر النطاق الكامل من الأنواع المستخدمة في البيئات التجارية السعودية:</p>
...
<p>يستخدم ويندو للإعلان وسائط فينيل احترافية متوافقة مع التطبيق والبيئة المقصودة:</p>
