...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'ملفات طبية في الرياض | ملفات رعاية صحية مخصصة السعودية | وينوو للإعلان',
            'meta_description' => 'ملفات طبية مخصصة وملفات وثائق رعاية صحية في الرياض — وينوو للإعلان يصنع ملفات طبية وملفات مرضى وقرطاسية رعاية صحية للمستشفيات والعيادات وشركات الأدوية في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>بالإضافة إلى المواد الموجهة للمرضى، تحتاج المؤسسات الصحية إلى ملفات إدارية مؤسسية لاستخدام الطاقم السريري. وينوو للإعلان ينتج:</p>
...
<p>لشركات الأدوية العاملة في سوق الأدوية النشط بالرياض، مواد عرض المندوبين الطبيين هي فئة متخصصة من إنتاج الملفات المؤسسية. وينوو للإعلان ينتج:</p>
...
<p>بيئة الرعاية الصحية في المملكة العربية السعودية ثنائية اللغة حقاً — يتواصل المرضى السعوديون والعرب بالعربية، بينما تتطلب نسبة كبيرة من الطاقم الطبي والمرضى المغتربين اللغة الإنجليزية. كل ملف وثائق طبي ينتجه وينوو للإعلان متاح بتنسيق ثنائي اللغة عربي-إنجليزي، مع تنضيد كلتا اللغتين بشكل صحيح وإعطائهما وزناً بصرياً متساوياً مناسباً لوظيفة الوثيقة.</p>
<p>للجهات الصحية الحكومية وشبه الحكومية في المملكة العربية السعودية، يأخذ النص العربي الأولوية في التسلسل التصميمي. للمستشفيات الخاصة المنتسبة دولياً، قد تُعطى كلتا اللغتين حضوراً بصرياً متساوياً. يطور وينوو للإعلان التخطيط ثنائي اللغة وفقاً للمتطلبات المحددة لكل عميل صحي.</p>

<h2>الأسئلة الشائعة حول الملفات الطبية</h2>

<h3>ما أنواع الملفات الطبية التي ينتجها وينوو للإعلان؟</h3>
<p>ينتج وينوو للإعلان ملفات سجلات المرضى من الورق المقوى وPVC، وملفات وثائق الوصفات والاستشارات، وملفات الحافظة الطبية بمشابك زنبركية للاستخدام السريري، وأظرف وصفات الصيدلية وحافظات الوثائق، وملفات مندوبي شركات الأدوية وملفات العروض التقديمية، وملفات القرطاسية المؤسسية للمستشفيات والعيادات بتصميم ثنائي اللغة عربي-إنجليزي.</p>

<h3>هل يمكن إنتاج الملفات الطبية بتصميم ثنائي اللغة عربي وإنجليزي؟</h3>
<p>نعم. جميع الملفات الطبية وملفات الوثائق الصحية التي ينتجها وينوو للإعلان يمكن تصميمها وطباعتها بتنسيق ثنائي اللغة عربي وإنجليزي — وهو أمر أساسي لبيئة الرعاية الصحية في الرياض حيث يحتاج كل من المرضى المغتربين والسعوديين إلى وثائق يمكنهم قراءتها. يُتعامل مع التصميم ثنائي اللغة داخلياً، مع تنضيد عربي مناسب لتطبيقات الوثائق السريرية.</p>

<h3>هل تنتجون ملفات ترويجية صيدلانية للمندوبين الطبيين؟</h3>
<p>نعم. تستخدم شركات الأدوية العاملة في المملكة العربية السعودية ملفات العروض التقديمية المؤسسية وملفات المساعدات التفصيلية كجزء من مجموعة أدوات تفصيل منتجات المندوب الطبي. ينتج وينوو للإعلان ملفات المساعدات التفصيلية الصيدلانية وملفات معلومات المنتجات وملفات عروض الدراسات السريرية والمنظمات المؤسسية للوثائق لفرق التسويق والمبيعات الصيدلانية.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع الملفات الطبية التي ينتجها وينوو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
