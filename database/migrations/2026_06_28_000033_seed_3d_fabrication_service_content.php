...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تصنيع ثلاثي الأبعاد في الرياض | حروف وعلامات ثلاثية الأبعاد السعودية | ويندو للإعلان',
            'meta_description' => 'تصنيع وتركيب عناصر ثلاثية الأبعاد في الرياض — ويندو للإعلان يصنع حروفاً وشعارات وعلامات ثلاثية الأبعاد وهياكل معارض وعناصر إعلانية مخصصة للشركات في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>في ثقافة الأعمال السعودية، حيث تحمل الانطباعات الأولى في اجتماعات العملاء وزناً كبيراً، تعد بيئة الاستقبال المتميزة مع <a href="/ar/services/directional-signage">لافتات إرشادية</a> مصنعة بجودة عالية أصلاً تجارياً. تقدم ويندو للإعلان استشارات للعملاء حول مواصفات اللافتات ثلاثية الأبعاد التي تتوافق مع موقع علامتهم التجارية والبيئة التي ستُركب فيها.</p>

<h2>الحروف والشعارات ثلاثية الأبعاد</h2>
<p>تعد الحروف والشعارات ثلاثية الأبعاد التطبيق الأكثر شيوعاً للتصنيع ثلاثي الأبعاد في البيئة المؤسسية. تصنع ويندو للإعلان:</p>
...
<p>تصنع ويندو للإعلان عناصر إعلانية ثلاثية الأبعاد خارجية مصنفة لظروف المناخ الخارجي في الرياض — مواد وتثبيتات محددة لمقاومة الحرارة والغبار والأشعة فوق البنفسجية.</p>

<h2>الأسئلة الشائعة حول التصنيع ثلاثي الأبعاد</h2>

<h3>ما المواد التي تستخدمها ويندو للإعلان في التصنيع ثلاثي الأبعاد؟</h3>
<p>تصنع ويندو للإعلان العناصر ثلاثية الأبعاد من الأكريليك (متوفر بتشطيبات شفافة وملونة ومرآوية)، والألمنيوم المصقول واللامع، والستانلس ستيل (مصقول ومرآوي ومطلي بالبودرة)، والفوم عالي الكثافة بتشطيب مطلي أو مغطى بالفينيل، وبلاستيك ABS، ومواد الألواح المركبة. تعتمد مواصفات المواد على بيئة التركيب ومتطلبات الإضاءة والتشطيب المطلوب من هوية العلامة التجارية.</p>

<h3>هل يمكنكم تصنيع لافتات ثلاثية الأبعاد مضيئة بإضاءة LED؟</h3>
<p>نعم. تصنع ويندو للإعلان لافتات ثلاثية الأبعاد مضيئة بإضاءة LED مدمجة في عدة تكوينات: إضاءة أمامية (ينبعث الضوء من وجه الحرف أو اللافتة)، إضاءة خلفية / هالو (ينبعث الضوء من خلف اللافتة باتجاه الجدار مما يخلق تأثير توهج)، وأكريليك مضاء من الحواف (ينتقل الضوء عبر الأكريليك من الحواف). اللافتات ثلاثية الأبعاد المضيئة فعالة بشكل خاص لواجهات المباني ومناطق الاستقبال وواجهات المتاجر.</p>

<h3>هل تصنعون هياكل معارض وعناصر بوثات؟</h3>
<p>نعم. تصنع ويندو للإعلان عناصر بوثات معارض ثلاثية الأبعاد مخصصة — منصات مؤسسية وكاونترات استقبال ومنصات عرض منتجات وأقواس علوية وعناصر إطار هيكلي. تُستخدم العناصر المصنعة ثلاثياً إلى جانب الرسوم المطبوعة لإنشاء بيئات معرضية متميزة معمارياً وذات حضور مادي ملموس.</p>

<h3>هل تقومون بتركيب اللافتات ثلاثية الأبعاد بعد التصنيع؟</h3>
<p>نعم. توفر ويندو للإعلان تركيباً كاملاً لجميع اللافتات والعناصر الهيكلية المصنعة ثلاثياً في جميع أنحاء الرياض. يتولى فريق التركيب لدينا التثبيت على الجدران والتثبيت الهيكلي والتوصيل الكهربائي للافتات المضيئة والتشطيب. ننسق مع إدارة المبنى للوصول للتركيب والتوقيت.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما المواد التي تستخدمها ويندو للإعلان في التصنيع ثلاثي الأبعاد؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تصنع ويندو للإعلان العناصر ثلاثية الأبعاد من الأكريليك (متوفر بتشطيبات شفافة وملونة ومرآوية)، والألمنيوم المصقول واللامع، والستانلس ستيل (مصقول ومرآوي ومطلي بالبودرة)، والفوم عالي الكثافة بتشطيب مطلي أو مغطى بالفينيل، وبلاستيك ABS، ومواد الألواح المركبة. تعتمد مواصفات المواد على بيئة التركيب ومتطلبات الإضاءة والتشطيب المطلوب من هوية العلامة التجارية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تصنع ويندو للإعلان عناصر بوثات معارض ثلاثية الأبعاد مخصصة — منصات مؤسسية وكاونترات استقبال ومنصات عرض منتجات وأقواس علوية وعناصر إطار هيكلي. تُستخدم العناصر المصنعة ثلاثياً إلى جانب الرسوم المطبوعة لإنشاء بيئات معرضية متميزة معمارياً وذات حضور مادي ملموس."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. توفر ويندو للإعلان تركيباً كاملاً لجميع اللافتات والعناصر الهيكلية المصنعة ثلاثياً في جميع أنحاء الرياض. يتولى فريق التركيب لدينا التثبيت على الجدران والتثبيت الهيكلي والتوصيل الكهربائي للافتات المضيئة والتشطيب. ننسق مع إدارة المبنى للوصول للتركيب والتوقيت."
      }
    }
  ]
}
