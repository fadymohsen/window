...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'هدايا دعائية في الرياض | دعاية وإعلان السعودية | ويندو للإعلان',
            'meta_description' => 'هدايا دعائية مخصصة وهدايا إعلانية للشركات في الرياض — ويندو للإعلان توفر هدايا ترويجية وقطع دعائية مميزة للمؤتمرات والمعارض والفعاليات في المملكة العربية السعودية. احصل على عرض سعر مجاني.',
...
<p>سواء كنت تعرض في معرض تجاري في الرياض، أو تستضيف فعالية مؤسسية، أو تحتفل باليوم الوطني، أو تكافئ عميلاً وفياً، فإن هدية مؤسسية متميزة تعزز هوية شركتك بطريقة لا يستطيع الإعلان الرقمي تحقيقها. تساعد ويندو للإعلان الشركات في جميع أنحاء المملكة العربية السعودية على اختيار وتخصيص وتوصيل هدايا دعائية تترك انطباعاً دائماً.</p>

<h2>تشكيلة هدايانا الدعائية</h2>
<p>توفر ويندو للإعلان هدايا دعائية وإعلانية تغطي كل فئة وميزانية:</p>
...
<p>كل هدية دعائية من ويندو للإعلان مخصصة لتحمل علامتك التجارية. تشمل خيارات التخصيص الطباعة الحريرية والتطريز والحفر بالليزر والطباعة الرقمية والنقش البارز وطلاء UV — كل تقنية مناسبة لمادة ومتطلب جمالي مختلف.</p>
...
<p>تنسق ويندو للإعلان الهدايا الدعائية جنباً إلى جنب مع <a href="/ar/services/exhibition-booth-execution">تنفيذ أجنحة المعارض</a>، لضمان وصول هداياك إلى مكان المعرض مع مواد جناحك وجاهزيتها للتوزيع من اليوم الأول للمعرض.</p>

<h2>طلبات الهدايا الشركاتية بالجملة في الرياض</h2>
<p>للطلبات المؤسسية الكبيرة، تقدم ويندو للإعلان أسعار الكميات والتوصيل الموحد. نتعامل مع طلبات تتراوح من 50 وحدة لفعالية واحدة إلى عشرات الآلاف من الوحدات لحملات على مستوى المملكة.</p>
...
<p>تغطي محفظة أعمالنا في الهدايا الدعائية مئات المشاريع لعملاء من الشركات والجهات الحكومية والعلامات التجارية والمنظمين في جميع أنحاء الرياض. تصفح المعرض أدناه لاستكشاف مجموعة الهدايا المؤسسية التي أنتجتها وسلمتها ويندو للإعلان.</p>

<h2>الأسئلة الشائعة حول الهدايا الدعائية</h2>

<h3>ما الهدايا الدعائية التي توفرها ويندو للإعلان في الرياض؟</h3>
<p>توفر ويندو للإعلان مجموعة واسعة من الهدايا الدعائية تشمل أقلام ودفاتر وأقراص USB وبنوك طاقة وأكواب وحقائب توت وحبال وسلاسل مفاتيح وإكسسوارات هواتف وتقاويم وهدايا تنفيذية فاخرة. جميع المنتجات مخصصة بالكامل بشعار وألوان علامتك التجارية.</p>
...
<p>نعم. توصل ويندو للإعلان الهدايا الدعائية للعملاء في جميع أنحاء المملكة العربية السعودية بما في ذلك الرياض وجدة والدمام والخبر ومدن أخرى. ننسق التوصيل بالجملة إلى أماكن الفعاليات والمكاتب ونقاط التوزيع في أي مكان في المملكة.</p>
...
<p>نعم. الهدايا الدعائية للمعارض من أكثر فئاتنا شعبية. توفر ويندو للإعلان هدايا معارض عملية ومؤسسية ولا تُنسى — تساعد زوار جناحك على تذكر شركتك بعد فترة طويلة من انتهاء الفعالية. ننسق مع طلب جناح المعرض الخاص بك لتوصيل سلس.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما الهدايا الدعائية التي توفرها ويندو للإعلان في الرياض؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "توفر ويندو للإعلان مجموعة واسعة من الهدايا الدعائية تشمل أقلام ودفاتر وأقراص USB وبنوك طاقة وأكواب وحقائب توت وحبال وسلاسل مفاتيح وإكسسوارات هواتف وتقاويم وهدايا تنفيذية فاخرة. جميع المنتجات مخصصة بالكامل بشعار وألوان علامتك التجارية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. توصل ويندو للإعلان الهدايا الدعائية للعملاء في جميع أنحاء المملكة العربية السعودية بما في ذلك الرياض وجدة والدمام والخبر ومدن أخرى. ننسق التوصيل بالجملة إلى أماكن الفعاليات والمكاتب ونقاط التوزيع في أي مكان في المملكة."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. الهدايا الدعائية للمعارض من أكثر فئاتنا شعبية. توفر ويندو للإعلان هدايا معارض عملية ومؤسسية ولا تُنسى — تساعد زوار جناحك على تذكر شركتك بعد فترة طويلة من انتهاء الفعالية. ننسق مع طلب جناح المعرض الخاص بك لتوصيل سلس."
      }
    }
  ]
}
