...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'شنط دعائية في الرياض | حقائب مخصصة وهدايا شركاتية السعودية | وينوو للإعلان',
            'meta_description' => 'شنط دعائية وحقائب مخصصة في الرياض — وينوو للإعلان يصمم وينتج شنط ترويجية وحقائب مخصصة وهدايا دعائية للشركات في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>الشنطة الدعائية هي واحدة من أكثر الهدايا الإعلانية فعالية في السوق السعودي — تنتقل مع المستلم، ويراها كل من حوله، وتعلن عن العلامة التجارية مع كل استخدام لأشهر أو سنوات. وينوو للإعلان يصمم وينتج <a href="/ar/services/promotional-gifts">هدايا دعائية</a> وشنط ترويجية مخصصة للشركات في جميع أنحاء الرياض والمملكة العربية السعودية: للتوزيع في المؤتمرات والفعاليات، وهدايا المناسبات الوطنية، وحملات الهدايا المؤسسية، والتغليف الترويجي.</p>
...
<p>للمؤتمرات والمعارض التجارية و<a href="/ar/services/event-festival">الفعاليات والمهرجانات</a> المؤسسية في جميع أنحاء الرياض، تكون شنطة الفعالية هي الانطباع الأول — توزع عند التسجيل وتحدد المعيار لكل عنصر آخر في الشنطة وفي الفعالية نفسها. ينسق وينوو للإعلان إنتاج شنط الفعاليات مع مجموعة مواد الفعالية الأوسع: تصميم الشنطة يتصل بالبانرات والبرامج وشاشات الرول أب عند التسجيل.</p>
<p>للفعاليات الكبيرة، تُنتج الشنط بأقسام فردية وإدراجات ومواد — برامج وأقلام ودفاتر وعناصر ذات علامة تجارية — مجمعة في شنط فعاليات جاهزة للتوزيع. يدير وينوو للإعلان التجميع الكامل وتسليم مجموعات شنط الفعاليات للمؤتمرات والتجمعات المؤسسية في جميع أنحاء الرياض.</p>
...
<p>يصمم وينوو للإعلان شنط المناسبات الوطنية بالألوان الوطنية السعودية مع شعار الشركة وعلامة المناسبة — منسقة مع <a href="/ar/services/employee-gift-boxes">علب هدايا الموظفين</a> ومجموعة الهدايا بالداخل لخلق تجربة هدايا موحدة. الإنتاج متاح لطلبات الهدايا المؤسسية الكبيرة في جميع أنحاء الرياض.</p>
...
<h3>ما أنواع الشنط الدعائية التي ينتجها وينوو للإعلان؟</h3>
<p>ينتج وينوو للإعلان شنط البولي بروبيلين غير المنسوجة (الأكثر استخداماً في المملكة العربية السعودية)، وحقائب التوت القماشية، وأكياس الهدايا الورقية بأحجام وأنماط متنوعة، وشنط الجوت والألياف الطبيعية، وشنط البوليستر ذات الأربطة للفعاليات والرياضة، والشنط الفاخرة من الجلد الصناعي والقماش للهدايا المؤسسية الراقية.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع الشنط الدعائية التي ينتجها وينوو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ينتج وينوو للإعلان شنط البولي بروبيلين غير المنسوجة (الأكثر استخداماً في المملكة العربية السعودية)، وحقائب التوت القماشية، وأكياس الهدايا الورقية بأحجام وأنماط متنوعة، وشنط الجوت والألياف الطبيعية، وشنط البوليستر ذات الأربطة للفعاليات والرياضة، والشنط الفاخرة من الجلد الصناعي والقماش للهدايا المؤسسية الراقية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تعتمد الكميات الدنيا للطلب على نوع الشنطة وطريقة الطباعة. شنط البولي بروبيلين غير المنسوجة بالطباعة الحريرية تبدأ من 100 وحدة. الشنط القماشية بالطباعة الحريرية تبدأ من 50 وحدة. الطباعة الرقمية بالألوان الكاملة متاحة بكميات أصغر، من 20 إلى 50 وحدة حسب حجم الشنطة. تواصل مع وينوو للإعلان لتفاصيل الحد الأدنى لأنواع الشنط المحددة."
      }
    },
    {
      "@type": "Question",
