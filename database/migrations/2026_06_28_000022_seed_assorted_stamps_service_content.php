...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'أختام متنوعة في الرياض | أختام شركاتية مخصصة السعودية | ويندو للإعلان',
            'meta_description' => 'أختام مخصصة وأختام شركاتية في الرياض — ويندو للإعلان يصنع أختاماً متنوعة للشركات تشمل أختاماً ذاتية الحبر وأختام التاريخ والأختام الرسمية. دعاية واعلان الرياض والسعودية. احصل على عرض سعر.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>يُعد ختم الشركة من أكثر الأدوات استخداماً في أي مكتب تجاري سعودي. من اعتماد المستندات إلى ختم المراسلات الواردة، تُعتبر الأختام أداة تشغيلية يومية تحمل أيضاً الهوية البصرية للشركة في كل بصمة تتركها. ويندو للإعلان يصنع أختاماً مخصصة متنوعة للشركات في جميع أنحاء الرياض والمملكة العربية السعودية — مصممة ومنتجة كجزء من حل متكامل للهوية المؤسسية والدعاية والإعلان.</p>
...
<p>لأقسام المالية وفرق الموارد البشرية ومكاتب الإدارة في الرياض التي تعالج كميات كبيرة من المستندات يومياً، الأختام ذاتية الحبر هي المعيار العملي. يوفر ويندو للإعلان أختاماً ذاتية الحبر بصيغة Trodat والصيغ المكافئة مع توفر وسائد حبر بديلة لجميع الأحجام الشائعة.</p>
...
<p>إلى جانب الأختام المكتبية القياسية، ينتج ويندو للإعلان أنواعاً خاصة من الأختام لتطبيقات محددة:</p>
...
<h3>ما أنواع الأختام التي يصنعها ويندو للإعلان؟</h3>
<p>يصنع ويندو للإعلان أختاماً ذاتية الحبر وأختام التاريخ وأختام العنوان وأختام وارد ومعتمد وأختام النصوص المخصصة وأختام الشعار والأختام الرسمية للشركات وأختام التوثيق والأختام المتخصصة لتطبيقات صناعية محددة. جميع الأختام متوفرة بالنص العربي أو الإنجليزي أو كليهما.</p>
...
<p>نعم. ينتج ويندو للإعلان أختاماً بنص عربي أو إنجليزي أو تخطيطات ثنائية اللغة بالكامل. يمكن استخدام خطوط عربية خطية للأختام الرسمية وأختام الشركات. نقوم بتنضيد النص العربي بشكل صحيح ونوفر نموذجاً رقمياً للموافقة عليه قبل إنتاج الختم.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع الأختام التي يصنعها ويندو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "يصنع ويندو للإعلان أختاماً ذاتية الحبر وأختام التاريخ وأختام العنوان وأختام وارد ومعتمد وأختام النصوص المخصصة وأختام الشعار والأختام الرسمية للشركات وأختام التوثيق والأختام المتخصصة لتطبيقات صناعية محددة. جميع الأختام متوفرة بالنص العربي أو الإنجليزي أو كليهما."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. ينتج ويندو للإعلان أختاماً بنص عربي أو إنجليزي أو تخطيطات ثنائية اللغة بالكامل. يمكن استخدام خطوط عربية خطية للأختام الرسمية وأختام الشركات. نقوم بتنضيد النص العربي بشكل صحيح ونوفر نموذجاً رقمياً للموافقة عليه قبل إنتاج الختم."
      }
    },
    {
      "@type": "Question",
