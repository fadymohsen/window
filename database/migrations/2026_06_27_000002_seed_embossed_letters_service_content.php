...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'أحرف بارزة ولافتات ثلاثية الأبعاد في الرياض | ويندو للإعلان',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>لافتتك هي أول ما يراه العملاء. تصنّع ويندو للإعلان أحرفاً بارزة ولافتات ثلاثية الأبعاد للشركات في جميع أنحاء الرياض — مصنوعة من الستانلس ستيل والأكريليك والألمنيوم والنحاس، مع خيارات إضاءة متاحة لأقصى رؤية نهاراً وليلاً.</p>
...
<p>تركب ويندو للإعلان الأحرف البارزة في مجموعة واسعة من البيئات التجارية والمؤسسية في الرياض:</p>
<ul>
...
<p>تصنع ويندو للإعلان الأحرف البارزة من الستانلس ستيل (مصقول أو مرآوي)، والأكريليك (شفاف أو ملون أو مرآوي)، والألمنيوم، والنحاس، وفوم PVC. يعتمد اختيار المادة على بيئتك وميزانيتك ومتطلباتك الجمالية.</p>
...
<p>تقدم ويندو للإعلان خدمة توريد وتركيب كاملة في جميع أنحاء الرياض والمملكة العربية السعودية. يتولى فريق التركيب لدينا التثبيت والتوصيل الكهربائي للأحرف المضيئة والتسوية والتشطيب — لتسليم لافتة جاهزة للاستخدام.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تصنع ويندو للإعلان الأحرف البارزة من الستانلس ستيل (مصقول أو مرآوي)، والأكريليك (شفاف أو ملون أو مرآوي)، والألمنيوم، والنحاس، وفوم PVC. يعتمد اختيار المادة على بيئتك وميزانيتك ومتطلباتك الجمالية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تقدم ويندو للإعلان خدمة توريد وتركيب كاملة في جميع أنحاء الرياض والمملكة العربية السعودية. يتولى فريق التركيب لدينا التثبيت والتوصيل الكهربائي للأحرف المضيئة والتسوية والتشطيب — لتسليم لافتة جاهزة للاستخدام."
      }
    },
    {
      "@type": "Question",
