...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_description' => 'استندات دعائية مخصصة وعارضات عرض للمعارض والمحلات التجارية والفعاليات في الرياض — ويندو للإعلان للدعاية والإعلان في السعودية. احصل على عرض سعر مجاني.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>الاستندات الدعائية هي أدوات الإعلان الأمامية في المملكة العربية السعودية. سواء كنت بحاجة إلى رول أب واحد لمؤتمر، أو نظام عرض كامل لمعرض تجاري، أو وحدة عرض تحمل علامتك التجارية لمتجرك، فإن ويندو للإعلان تصنع وتسلم كل أنواع الاستندات الترويجية في الرياض والمملكة.</p>
...
<p>بصفتها إحدى شركات الإعلان الرائدة في الرياض، تنتج ويندو للإعلان استندات دعائية تُستخدم في المعارض التجارية ومراكز التسوق وردهات الفنادق والفعاليات الحكومية والمكاتب المؤسسية في جميع أنحاء المملكة العربية السعودية. كل استند مصمم ليكون سهل التجميع والنقل وإعادة الاستخدام عبر فعاليات متعددة.</p>

<h2>أنواع الاستندات الدعائية التي ننتجها</h2>
<p>تصنع ويندو للإعلان الطيف الكامل من الاستندات الدعائية المستخدمة في سوق الإعلان السعودي:</p>
...
<p>يتطلب كل تطبيق مواصفات استند مختلفة، وتوفرها ويندو للإعلان جميعاً — بما في ذلك تجهيزات <a href="/ar/services/exhibition-booth-execution">أجنحة المعارض</a> الكاملة — بنفس معيار الجودة.</p>

<h2>جودة التصميم والطباعة</h2>
<p>تحدد الجودة البصرية لاستندك الدعائي مدى احترافية نظرة الجمهور لعلامتك التجارية. تستخدم ويندو للإعلان الطباعة الرقمية عالية الدقة بالحجم الكبير على ركائز مميزة — لإنتاج ألوان زاهية ونصوص حادة وصور فوتوغرافية تصمد عند مسافات المشاهدة القريبة.</p>
...
<h2>لماذا تختار شركات الرياض ويندو للإعلان؟</h2>
<p>ويندو للإعلان شركة إعلان متكاملة الخدمات في الرياض — وليست مجرد مطبعة. عندما تطلب استنداً دعائياً منا، تحصل على دعم التصميم وخبرة الإنتاج وتنسيق التسليم من فريق واحد تحت سقف واحد.</p>
...
<p>تصفح معرض مشاريعنا لمشاهدة مجموعة الاستندات الدعائية وعارضات العرض التي أنتجتها ويندو للإعلان لعملاء في جميع أنحاء الرياض والمملكة العربية السعودية. يتضمن معرض أعمالنا رول أب واستندات لاما وأنظمة معارض وعارضات بوب أب ووحدات عرض تجزئة عبر عشرات القطاعات.</p>

<h2>الأسئلة الشائعة حول الاستندات الدعائية</h2>

<h3>ما أنواع الاستندات الدعائية التي تقدمها ويندو للإعلان في الرياض؟</h3>
<p>تقدم ويندو للإعلان مجموعة كاملة من الاستندات الدعائية الترويجية تشمل بانرات الرول أب وعارضات البوب أب واستندات لاما والمكعبات الترويجية وبانرات X وبانرات L وعارضات الطاولة وأنظمة استندات المعارض المصممة خصيصاً. جميع الاستندات تُنتج بطباعة ملونة عالية الدقة.</p>

<h3>هل يمكن تخصيص الاستندات الدعائية بتصميم علامتنا التجارية؟</h3>
<p>نعم. كل استند دعائي من ويندو للإعلان مخصص بالكامل بتصميم علامتك التجارية وألوانها وشعارها ورسائلها. يمكن لفريق التصميم لدينا إنشاء العمل الفني من الصفر أو العمل من إرشادات علامتك التجارية الحالية. يُقدَّم نموذج رقمي للموافقة قبل الإنتاج.</p>
...
<p>بانر الرول أب هو نوع واحد من الاستندات الدعائية حيث يُطوى التصميم المطبوع داخل القاعدة للتخزين والنقل المدمج. الاستندات الدعائية فئة أوسع تشمل أنظمة البوب أب واستندات لاما والمكعبات الترويجية وعارضات المعارض المعيارية. توفر ويندو للإعلان جميع الأشكال.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع الاستندات الدعائية التي تقدمها ويندو للإعلان في الرياض؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تقدم ويندو للإعلان مجموعة كاملة من الاستندات الدعائية الترويجية تشمل بانرات الرول أب وعارضات البوب أب واستندات لاما والمكعبات الترويجية وبانرات X وبانرات L وعارضات الطاولة وأنظمة استندات المعارض المصممة خصيصاً. جميع الاستندات تُنتج بطباعة ملونة عالية الدقة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. كل استند دعائي من ويندو للإعلان مخصص بالكامل بتصميم علامتك التجارية وألوانها وشعارها ورسائلها. يمكن لفريق التصميم لدينا إنشاء العمل الفني من الصفر أو العمل من إرشادات علامتك التجارية الحالية. يُقدَّم نموذج رقمي للموافقة قبل الإنتاج."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "بانر الرول أب هو نوع واحد من الاستندات الدعائية حيث يُطوى التصميم المطبوع داخل القاعدة للتخزين والنقل المدمج. الاستندات الدعائية فئة أوسع تشمل أنظمة البوب أب واستندات لاما والمكعبات الترويجية وعارضات المعارض المعيارية. توفر ويندو للإعلان جميع الأشكال."
      }
    }
  ]
}
