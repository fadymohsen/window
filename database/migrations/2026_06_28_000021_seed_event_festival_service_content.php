...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تنظيم حفلات ومهرجانات في الرياض | فعاليات وإعلانات السعودية | ويندو للإعلان',
            'meta_description' => 'تنظيم حفلات ومهرجانات في الرياض — ويندو للإعلان يدير الفعاليات الشركاتية والمهرجانات العامة وتشغيل الحملات الإعلانية للشركات والجهات الحكومية في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>تنتج ويندو للإعلان حزم إعلانية منسقة للفعاليات حيث يشترك كل عنصر في نفس اللغة التصميمية. بدلاً من تجميع قطع غير متناسقة من موردين مختلفين، ينتج ملخص إبداعي واحد من فريقنا كل قطعة تحمل علامة تجارية تحتاجها الفعالية — من أكبر خلفية مسرح إلى أصغر هدية ترويجية.</p>

<h2>خدمات إنتاج المهرجانات</h2>
<p>للمهرجانات العامة والفعاليات الترفيهية الكبيرة في الرياض، تقدم ويندو للإعلان خدمات إنتاج إعلاني للمهرجانات:</p>
...
<p>تنسق ويندو للإعلان مجموعة المواد الإعلانية الكاملة لفعاليات الشركات: هوية المكان، وقطع الوسط للطاولات، وأنظمة المسرح والخلفيات، والهدايا والجوائز ذات العلامة التجارية، وخلفيات التصوير، والمطبوعات الخاصة بالفعالية. نعمل ضمن إرشادات الهوية المؤسسية للشركة المنظمة، لضمان أن تعكس الفعالية معايير العلامة التجارية بدلاً من مظهر فعالية عام. يضمن فريق <a href="/ar/services/events-conferences">الفعاليات والمؤتمرات</a> لدينا تنسيقاً سلساً عبر جميع عناصر الإنتاج.</p>

<h2>إنتاج فعاليات اليوم الوطني ويوم التأسيس</h2>
<p>يُعد اليوم الوطني السعودي في سبتمبر ويوم التأسيس في فبراير أعلى فترتين طلباً في تقويم الفعاليات والإعلان في الرياض. تخطط ويندو للإعلان تقويم إنتاجها مسبقاً لضمان القدرة الاستيعابية لحجم هوية الفعاليات والأعلام والبانرات والهدايا والمواد الترويجية المطلوبة في هذه الفترات.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تنظم ويندو للإعلان وتنتج المواد الإعلانية للفعاليات عبر المملكة العربية السعودية بما في ذلك جدة والخبر والدمام ومكة المكرمة. للفعاليات خارج الرياض، ننسق الإنتاج والخدمات اللوجستية من قاعدتنا في الرياض، مع فرق ذات خبرة متاحة لتركيب وتجهيز الفعاليات على مستوى المملكة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "للفعاليات والمهرجانات الكبيرة، نوصي بالتواصل مع ويندو للإعلان قبل 4 إلى 6 أسابيع على الأقل من تاريخ الفعالية. يمكن استيعاب فعاليات الشركات ذات متطلبات المواد الإعلانية القياسية بإشعار مسبق من 2 إلى 3 أسابيع. لفعاليات اليوم الوطني ويوم التأسيس حيث يكون الطلب مرتفعاً عبر الرياض، نوصي بالحجز قبل 6 إلى 8 أسابيع مسبقاً."
      }
    }
  ]
}
