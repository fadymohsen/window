...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'إدارة سوشيال ميديا في الرياض | تسويق منصات التواصل السعودية | وينوو للإعلان',
            'meta_description' => 'إدارة وتسويق منصات التواصل الاجتماعي في الرياض — وينوو للإعلان يصمم المحتوى ويدير الحسابات ويشغّل الحملات المدفوعة على إنستغرام وسناب تشات وتيك توك وتويتر. دعاية واعلان الرياض. احصل على استشارة مجانية.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>تمتلك المملكة العربية السعودية واحداً من أعلى معدلات التفاعل على وسائل التواصل الاجتماعي في العالم. جمهور المستهلكين والأعمال في الرياض نشط يومياً على سناب تشات وإنستغرام وتيك توك وتويتر — ويتوقعون من العلامات التجارية التي يتفاعلون معها الحفاظ على حضور متسق وعالي الجودة. تدير وينوو للإعلان حسابات التواصل الاجتماعي للشركات في الرياض وجميع أنحاء المملكة العربية السعودية، وتتولى إنتاج المحتوى وإدارة الحسابات والإعلانات المدفوعة كجزء من حل <a href="/ar/services/digital-marketing">تسويق رقمي</a> واتصالات متكامل.</p>
...
<p>توصي وينوو للإعلان بالمزيج المناسب من المنصات لكل عميل بناءً على ملف الجمهور المحدد ونوع العمل وأهداف الحملة — وليس قالباً يُطبق بشكل موحد.</p>

<h2>إنتاج محتوى السوشيال ميديا للسوق السعودي</h2>
<p>يحتاج محتوى وسائل التواصل الاجتماعي الفعال في المملكة العربية السعودية إلى العمل بلغتين — العربية أساسية والإنجليزية ثانوية — ويجب أن يعكس السياق الثقافي للسوق السعودي. تنتج وينوو للإعلان كل محتوى وسائل التواصل الاجتماعي داخلياً:</p>
...
<p>تبني إدارة المحتوى العضوي حضوراً مع مرور الوقت — بينما تسرّع الإعلانات المدفوعة الوصول فوراً. تدير وينوو للإعلان حملات وسائل التواصل الاجتماعي المدفوعة إلى جانب إدارة المحتوى العضوي، مما يضمن عمل الاثنين معاً بدلاً من العمل بشكل مستقل.</p>
...
<p>تصل حملات تيك توك المدفوعة إلى الجمهور السعودي الأصغر سناً بإعلانات فيديو قصيرة تظهر ضمن تدفق المحتوى الأصلي. تنتج وينوو للإعلان محتوى فيديو أصلي لتيك توك بدلاً من إعادة استخدام محتوى من منصات أخرى.</p>

<h2>محتوى ثنائي اللغة عربي وإنجليزي</h2>
<p>كل قطعة محتوى تنتجها وينوو للإعلان لإدارة وسائل التواصل الاجتماعي في المملكة العربية السعودية متوفرة بالعربية والإنجليزية. التعليقات العربية هي المعيار للمنشورات الموجهة للمستهلكين التي تستهدف الجمهور السعودي. تُستخدم الإنجليزية للاتصالات المؤسسية ومحتوى B2B والعلامات التجارية ذات البعد الدولي في جمهورها.</p>
...
<p>تقدم وينوو للإعلان تقارير أداء شهرية لوسائل التواصل الاجتماعي تغطي الوصول والانطباعات ومعدل التفاعل ونمو المتابعين ومشاهدات القصص وأداء الفيديو عبر كل منصة. تُقدم التقارير بالعربية أو الإنجليزية حسب تفضيل العميل وتتضمن ملخصاً واضحاً لما تعنيه البيانات وما نوصي بتعديله.</p>
...
<h3>ما المنصات التي تديرها وينوو للإعلان للعملاء السعوديين؟</h3>
<p>تدير وينوو للإعلان إنستغرام وسناب تشات وتيك توك وتويتر ولينكد إن للعملاء في المملكة العربية السعودية. سناب تشات هو المنصة الأعلى وصولاً في المملكة وغالباً ما يكون توصيتنا الأساسية للعلامات التجارية الموجهة للمستهلكين في الرياض. إنستغرام ضروري للعلامات التجارية البصرية وشركات المنتجات. لينكد إن موصى به لخدمات B2B والشركات. ننصح بالمزيج المناسب من المنصات بناءً على جمهورك ونوع عملك.</p>

<h3>هل تنتجون المحتوى أم يقدمه العميل؟</h3>
<p>تنتج وينوو للإعلان كل المحتوى داخلياً — التصميم وكتابة النصوص بالعربية والإنجليزية وإنتاج الفيديو. يراجع العملاء ويعتمدون تقويم المحتوى الشهري قبل نشر أي شيء. إذا كان لدى العميل صور أو مقاطع فيديو خاصة يريد استخدامها، يمكننا دمجها في إنتاج المحتوى إلى جانب المواد الأصلية التي ننتجها.</p>

<h3>ما الذي تتضمنه باقة إدارة السوشيال ميديا؟</h3>
<p>تتضمن باقة إدارة السوشيال ميديا من وينوو للإعلان تخطيط تقويم المحتوى الشهري والتصميم الجرافيكي وكتابة النصوص لجميع المنشورات وإنتاج القصص والريلز والجدولة والنشر وإدارة المجتمع مع الرد على التعليقات والرسائل وتقرير أداء شهري. إدارة حملات الإعلانات المدفوعة متاحة كإضافة لإدارة المحتوى العضوي.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما المنصات التي تديرها وينوو للإعلان للعملاء السعوديين؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تدير وينوو للإعلان إنستغرام وسناب تشات وتيك توك وتويتر ولينكد إن للعملاء في المملكة العربية السعودية. سناب تشات هو المنصة الأعلى وصولاً في المملكة وغالباً ما يكون توصيتنا الأساسية للعلامات التجارية الموجهة للمستهلكين في الرياض. إنستغرام ضروري للعلامات التجارية البصرية وشركات المنتجات. لينكد إن موصى به لخدمات B2B والشركات. ننصح بالمزيج المناسب من المنصات بناءً على جمهورك ونوع عملك."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تنتج وينوو للإعلان كل المحتوى داخلياً — التصميم وكتابة النصوص بالعربية والإنجليزية وإنتاج الفيديو. يراجع العملاء ويعتمدون تقويم المحتوى الشهري قبل نشر أي شيء. إذا كان لدى العميل صور أو مقاطع فيديو خاصة يريد استخدامها، يمكننا دمجها في إنتاج المحتوى إلى جانب المواد الأصلية التي ننتجها."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تتضمن باقة إدارة السوشيال ميديا من وينوو للإعلان تخطيط تقويم المحتوى الشهري والتصميم الجرافيكي وكتابة النصوص لجميع المنشورات وإنتاج القصص والريلز والجدولة والنشر وإدارة المجتمع مع الرد على التعليقات والرسائل وتقرير أداء شهري. إدارة حملات الإعلانات المدفوعة متاحة كإضافة لإدارة المحتوى العضوي."
      }
    },
    {
      "@type": "Question",
