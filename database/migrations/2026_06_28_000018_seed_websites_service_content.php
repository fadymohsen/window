...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تصميم مواقع في الرياض | تطوير مواقع السعودية | وينوو للإعلان',
            'meta_description' => 'تصميم وتطوير مواقع احترافية في الرياض — وينوو للإعلان يبني مواقع شركاتية وصفحات هبوط ومتاجر الكترونية للشركات في السعودية. مواقع ثنائية اللغة تعكس هويتك التجارية. دعاية واعلان الرياض. احصل على استشارة.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>الموقع الإلكتروني للشركة هو الأصل الإعلاني الرقمي المركزي لأي عمل تجاري في الرياض والمملكة العربية السعودية. هو المكان الذي يتحقق فيه العملاء المحتملون من مصداقيتك، ويستعرضون أعمالك، ويفهمون خدماتك، ويقررون ما إذا كانوا سيتواصلون معك. تصمم وتطور وينوو للإعلان مواقع إلكترونية للشركات السعودية كامتداد متكامل لأعمال الهوية التجارية والإعلان الأوسع التي نديرها — لضمان أن موقعك يبدو ويشعر ويتواصل بنفس الدقة التي تتمتع بها موادك الإعلانية المادية.</p>
...
<p>تبني وينوو للإعلان أربعة أنواع رئيسية من المواقع لعملاء الرياض:</p>
...
<p>سرعة التحميل على اتصالات الجوال ضرورية في السوق السعودي. تحسّن وينوو للإعلان الصور والنصوص البرمجية والكود لضمان تحميل المواقع بسرعة على سرعات شبكات الجوال المعتادة في الرياض — الصفحات البطيئة التحميل تفقد الزوار قبل حتى رؤية المحتوى.</p>

<h2>تكامل تصميم الموقع والبروفيل</h2>
<p>لكثير من العملاء في الرياض، مشروع الموقع عنصر واحد من حزمة تواصل تجاري أوسع تشمل <a href="/ar/services/profile-design-printing">تصميم وطباعة البروفيل</a> و<a href="/ar/services/business-prints">تصميم الكتالوج</a> والهوية البصرية لـ<a href="/ar/services/social-media">وسائل التواصل الاجتماعي</a>. تنسق وينوو للإعلان هذه العناصر معاً — لضمان أن موقعك وبروفيل شركتك والكتالوج المطبوع يتشاركون جميعاً نفس الهوية البصرية وبنية المحتوى.</p>
...
<h3>هل تبني وينوو للإعلان مواقع ثنائية اللغة عربي-إنجليزي؟</h3>
...
<h3>ما أنواع المواقع التي تبنيها وينوو للإعلان؟</h3>
<p>تبني وينوو للإعلان مواقع عرض مؤسسي ومواقع معرض أعمال وخدمات وصفحات هبوط للحملات ومتاجر إلكترونية لبيع المنتجات ونماذج حجز واستفسار لشركات الخدمات. معظم العملاء في الرياض يحتاجون موقعاً مؤسسياً يعرض خدمات الشركة وفريقها وأعمالها ومعلومات الاتصال بوضوح واحترافية.</p>
...
<p>نعم. جميع المواقع التي تبنيها وينوو للإعلان مصممة بأولوية الجوال — مصممة لشاشات الهواتف الذكية قبل سطح المكتب، عاكسةً حقيقة أن غالبية حركة الإنترنت في السعودية تأتي من الأجهزة المحمولة. نختبر كل موقع على أكثر تركيبات الأجهزة والمتصفحات استخداماً في السوق السعودي قبل الإطلاق.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "هل تبني وينوو للإعلان مواقع ثنائية اللغة عربي-إنجليزي؟",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "ما أنواع المواقع التي تبنيها وينوو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تبني وينوو للإعلان مواقع عرض مؤسسي ومواقع معرض أعمال وخدمات وصفحات هبوط للحملات ومتاجر إلكترونية لبيع المنتجات ونماذج حجز واستفسار لشركات الخدمات. معظم العملاء في الرياض يحتاجون موقعاً مؤسسياً يعرض خدمات الشركة وفريقها وأعمالها ومعلومات الاتصال بوضوح واحترافية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. جميع المواقع التي تبنيها وينوو للإعلان مصممة بأولوية الجوال — مصممة لشاشات الهواتف الذكية قبل سطح المكتب، عاكسةً حقيقة أن غالبية حركة الإنترنت في السعودية تأتي من الأجهزة المحمولة. نختبر كل موقع على أكثر تركيبات الأجهزة والمتصفحات استخداماً في السوق السعودي قبل الإطلاق."
      }
    }
  ]
}
