...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'بوب أب استندات عرض في الرياض | عارضات دعائية محمولة | وينوو للإعلان',
            'meta_description' => 'استندات بوب أب مخصصة وعارضات دعائية محمولة في الرياض — وينوو للإعلان يصمم وينتج أنظمة بوب أب للمعارض والفعاليات والترويج في المحلات. دعاية وإعلان الرياض والسعودية. احصل على عرض سعر.',
...
<p>تُعد استندات البوب أب من أكثر الاستندات الدعائية المحمولة شعبية في سوق المعارض السعودي لأنها توفر التأثير البصري لخلفية كبيرة مع سهولة حقيبة سفر محمولة. يصمم وينوو للإعلان وينتج أنظمة بوب أب للشركات في جميع أنحاء الرياض والمملكة.</p>

<h2>أنواع أنظمة البوب أب التي ننتجها</h2>
<p>يوفر وينوو للإعلان ثلاثة تكوينات رئيسية لاستندات البوب أب:</p>
...
<p>جودة الرسومات المطبوعة تحدد التأثير البصري لاستند البوب أب. يبتكر فريق التصميم في وينوو للإعلان رسومات بعرض كامل وسلسة تعمل عبر كامل سطح العرض — لضمان عدم وجود وصلات محرجة أو لوحات غير متوازنة أو عناصر تصميم تختفي في هيكل الإطار.</p>
...
<p>تشمل محفظة أعمالنا في البوب أب تجهيزات المعارض وإعدادات قاعات المؤتمرات وعروض الترويج في المحلات وبيئات الفعاليات المؤسسية في جميع أنحاء الرياض. تصفح المعرض لاستكشاف مجموعة أنظمة البوب أب التي أنتجها وسلّمها وينوو للإعلان.</p>
...
<p>نعم. هياكل استندات البوب أب قابلة لإعادة الاستخدام ويمكن استبدال لوحات الرسومات المطبوعة بشكل مستقل. هذا يجعل أنظمة البوب أب استثماراً فعالاً من حيث التكلفة على المدى الطويل — تُحدّث الرسومات لحملة أو فعالية جديدة دون استبدال الهيكل. يوفر وينوو للإعلان لوحات رسومات بديلة لأنظمة البوب أب الموجودة.</p>

<h3>هل استندات البوب أب مناسبة للاستخدام الخارجي؟</h3>
<p>استندات البوب أب مصممة بشكل أساسي للاستخدام الداخلي في المعارض والمؤتمرات وبيئات البيع بالتجزئة. للاستخدام الخارجي في ظروف المملكة العربية السعودية، نوصي بنظام استند أكثر متانة مثل بانر مع إطار أو عرض قماش شد خارجي. تواصل مع وينوو للإعلان وسنوصي بالنظام الأنسب لتطبيقك الخارجي.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. هياكل استندات البوب أب قابلة لإعادة الاستخدام ويمكن استبدال لوحات الرسومات المطبوعة بشكل مستقل. هذا يجعل أنظمة البوب أب استثماراً فعالاً من حيث التكلفة على المدى الطويل — تُحدّث الرسومات لحملة أو فعالية جديدة دون استبدال الهيكل. يوفر وينوو للإعلان لوحات رسومات بديلة لأنظمة البوب أب الموجودة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "استندات البوب أب مصممة بشكل أساسي للاستخدام الداخلي في المعارض والمؤتمرات وبيئات البيع بالتجزئة. للاستخدام الخارجي في ظروف المملكة العربية السعودية، نوصي بنظام استند أكثر متانة مثل بانر مع إطار أو عرض قماش شد خارجي. تواصل مع وينوو للإعلان وسنوصي بالنظام الأنسب لتطبيقك الخارجي."
      }
    }
  ]
}
