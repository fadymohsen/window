...
return new class extends Migration
{
    ...
    private string $coverPath = 'blogs/covers/exhibition-booth-manufacturing-saudi-arabia-window.webp';
...
HTML;
    ...
    public function down(): void
    {
        ...
        if ($blog->cover === $this->coverPath) {
            DB::table('blogs')->where('id', $blog->id)->update(['cover' => 'blogs/covers/placeholder-exhibition-booth-manufacturing.webp']);
        }
    ...
    {
        $source = base_path('resources/blog-assets/exhibition-booth-manufacturing-saudi-arabia-window.jpg');
        if (!is_file($source)) {
            return;
        }
