...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تنفيذ أجنحة المعارض في الرياض | وينوو للإعلان',
...
<p>تتولى وينوو للإعلان سلسلة التنفيذ بالكامل داخلياً: تصميم المفهوم، والتصنيع الهيكلي، والطباعة المؤسسية، والإضاءة، والأثاث، والتركيب في الموقع. تسلمنا ملخصك وإرشادات علامتك التجارية — ونسلمك جناحاً جاهزاً للعرض.</p>
...
<p>كل عنصر من جناحك يُنتج ويُدار بواسطة وينوو للإعلان:</p>
<ul>
...
<h2>لماذا وينوو للإعلان لأجنحة المعارض؟</h2>
<p>تعود الشركات في الرياض إلى وينوو للإعلان لمعارضها لأننا نزيل عبء التنسيق. لا إدارة مصمم هنا ومطبعة هناك ونجار في مكان آخر — نحن جهة اتصال واحدة وفاتورة واحدة وفريق واحد مسؤول.</p>
...
<p>تختلف تكاليف أجنحة المعارض حسب الحجم والمواد وتعقيد التصميم. في وينوو للإعلان، نقدم حلولاً مخصصة لكل ميزانية. تواصل معنا للحصول على عرض سعر مجاني مصمم وفق متطلبات فعاليتك.</p>
...
<p>نعم. توفر وينوو للإعلان خدمات أجنحة معارض شاملة تشمل التصميم والطباعة والتصنيع والتركيب في الموقع والتفكيك بعد الفعالية في جميع أنحاء الرياض والمملكة العربية السعودية.</p>
...
<p>بنت وينوو للإعلان أجنحة للعارضين في مركز الرياض الدولي للمؤتمرات والمعارض، ومعارض حي جاكس، ومؤتمر ليب التقني، وسيتي سكيب، ومعارض تجارية حكومية متنوعة في جميع أنحاء المملكة العربية السعودية.</p>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تختلف تكاليف أجنحة المعارض حسب الحجم والمواد وتعقيد التصميم. في وينوو للإعلان، نقدم حلولاً مخصصة لكل ميزانية. تواصل معنا للحصول على عرض سعر مجاني مصمم وفق متطلبات فعاليتك."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. توفر وينوو للإعلان خدمات أجنحة معارض شاملة تشمل التصميم والطباعة والتصنيع والتركيب في الموقع والتفكيك بعد الفعالية في جميع أنحاء الرياض والمملكة العربية السعودية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "بنت وينوو للإعلان أجنحة للعارضين في مركز الرياض الدولي للمؤتمرات والمعارض، ومعارض حي جاكس، ومؤتمر ليب التقني، وسيتي سكيب، ومعارض تجارية حكومية متنوعة في جميع أنحاء المملكة العربية السعودية."
      }
    }
  ]
}
