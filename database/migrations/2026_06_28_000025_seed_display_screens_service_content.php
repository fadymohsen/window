...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'شاشات عرض في الرياض | شاشات إعلانية رقمية السعودية | ويندو للإعلان',
            'meta_description' => 'شاشات عرض وشاشات إعلانية رقمية في الرياض — ويندو للإعلان يوفر ويثبت ويدير شاشات عرض رقمية للمتاجر والمكاتب والمعارض والفعاليات. دعاية واعلان الرياض والسعودية. احصل على عرض سعر.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>أصبحت شاشات العرض الرقمية الوسيلة الإعلانية والمعلوماتية المعتمدة في المتاجر والمكاتب المؤسسية والفنادق والمطاعم وبيئات المعارض في جميع أنحاء الرياض. تتواصل شاشة العرض بشكل ديناميكي — تدوير العروض الترويجية وتشغيل فيديوهات العلامة التجارية وعرض المعلومات الفورية والتحديث عن بُعد دون إعادة طباعة أو تركيب مواد مادية. توفر ويندو للإعلان وتركب وتدير شاشات العرض الرقمية كجزء من نظام <a href="/ar/services/display-stands">عرض إعلاني</a> متكامل للأعمال في جميع أنحاء المملكة العربية السعودية.</p>
...
<p>توفر ويندو للإعلان شاشات العرض كعناصر عرض إعلانية مستقلة أو كأجزاء متكاملة من نظام إعلاني أكبر — منسقة مع اللافتات المادية والستاندات الترويجية والمواد ذات العلامة التجارية.</p>

<h2>أنواع شاشات العرض التي نوفرها</h2>
<p>توفر ويندو للإعلان حلول شاشات عرض تجارية للسوق السعودي:</p>
...
<p>فعالية شاشة العرض تعتمد على جودة المحتوى المعروض عليها. تنتج ويندو للإعلان المحتوى الإعلاني الرقمي لشاشات العرض كجزء متكامل من خدمة توفير وتركيب الشاشات — لضمان وصول الشاشات جاهزة لعرض محتوى مصمم باحترافية ومتوافق مع العلامة التجارية.</p>
...
<p>للعملاء الذين يرغبون في تحديث محتوى شاشاتهم بانتظام، توفر ويندو للإعلان خدمة إدارة المحتوى مع تحديثات مجدولة وتغييرات الحملات الموسمية ومراجعات المحتوى عند الطلب تُدار عن بُعد.</p>
...
<p>تنسق ويندو للإعلان تركيب شاشات العرض مع بناء <a href="/ar/services/exhibition-booth-execution">جناح المعرض</a> الأوسع — لضمان وضع الشاشات بشكل صحيح ضمن هيكل الجناح وإخفاء الكابلات ضمن التصميم ومواءمة المحتوى المعروض مع حملة المعرض وهوية العلامة التجارية. تتوفر ستاندات الشاشات التي تكمل أنظمة <a href="/ar/services/lama-stand">ستاند لاما</a> والرول أب والعرض الترويجي كجزء من باقة معارض متكاملة.</p>

<h2>التركيب والمواصفات التقنية</h2>
<p>تدير ويندو للإعلان التركيب الكامل لشاشات العرض في مواقع العملاء في جميع أنحاء الرياض. تشمل خدمة التركيب لدينا المسح الميداني واختيار الحوامل أو الستاندات وتوجيه الكابلات وإخفاءها والاتصال بالشبكة لإدارة المحتوى عن بُعد وإعداد المحتوى الأولي واختبار التشغيل قبل التسليم.</p>
...
<h3>ما أنواع شاشات العرض التي توفرها ويندو للإعلان؟</h3>
<p>توفر ويندو للإعلان شاشات عرض LCD و LED تجارية بأحجام من 32 بوصة إلى ألواح 98 بوصة كبيرة، وألواح جدران فيديو LED للتركيبات السلسة متعددة الشاشات، وشاشات خارجية عالية السطوع لبيئات أشعة الشمس المباشرة، وشاشات لمس تفاعلية لتطبيقات التجزئة والضيافة.</p>

<h3>هل يمكنكم إدارة المحتوى المعروض على الشاشات؟</h3>
<p>نعم. توفر ويندو للإعلان إدارة محتوى اللافتات الرقمية كجزء من خدمة شاشات العرض. يمكننا تصميم وتحديث المحتوى المعروض على شاشاتكم وفق جدول منتظم — بما في ذلك الرسومات الثابتة والفيديوهات الترويجية ومعلومات الفعاليات وتدوير المحتوى المجدول. إدارة المحتوى عن بُعد تعني إمكانية تحديث شاشاتكم دون زيارات ميدانية.</p>

<h3>هل شاشات العرض مناسبة للإعلان الخارجي في السعودية؟</h3>
<p>نعم، مع المواصفات المناسبة للشاشة. الشاشات التجارية العادية مصممة للاستخدام الداخلي. شاشات العرض الخارجية لمناخ المملكة العربية السعودية تتطلب ألواح عالية السطوع (2,000 شمعة أو أكثر للرؤية تحت أشعة الشمس المباشرة) وحاويات مقاومة للطقس مصنفة لنطاق درجات الحرارة في الرياض وأسطح شاشات مقاومة للأشعة فوق البنفسجية. تحدد ويندو للإعلان الشاشات الخارجية المناسبة لبيئة التركيب المحددة.</p>

<h3>هل تركبون الشاشات أم توفرونها فقط؟</h3>
<p>توفر ويندو للإعلان التوفير والتركيب الكامل. يتولى فريق التركيب لدينا التثبيت على الحائط والتعليق من السقف وتجميع ستاندات الشاشات القائمة بذاتها وإدارة الكابلات والاتصال بالشبكة وإعداد البرمجيات الأولي. ننسق المتطلبات الكهربائية مع مقاول العميل ونجري التشغيل والاختبار قبل التسليم.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع شاشات العرض التي توفرها ويندو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "توفر ويندو للإعلان شاشات عرض LCD و LED تجارية بأحجام من 32 بوصة إلى ألواح 98 بوصة كبيرة، وألواح جدران فيديو LED للتركيبات السلسة متعددة الشاشات، وشاشات خارجية عالية السطوع لبيئات أشعة الشمس المباشرة، وشاشات لمس تفاعلية لتطبيقات التجزئة والضيافة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. توفر ويندو للإعلان إدارة محتوى اللافتات الرقمية كجزء من خدمة شاشات العرض. يمكننا تصميم وتحديث المحتوى المعروض على شاشاتكم وفق جدول منتظم — بما في ذلك الرسومات الثابتة والفيديوهات الترويجية ومعلومات الفعاليات وتدوير المحتوى المجدول. إدارة المحتوى عن بُعد تعني إمكانية تحديث شاشاتكم دون زيارات ميدانية."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم، مع المواصفات المناسبة للشاشة. الشاشات التجارية العادية مصممة للاستخدام الداخلي. شاشات العرض الخارجية لمناخ المملكة العربية السعودية تتطلب ألواح عالية السطوع (2,000 شمعة أو أكثر للرؤية تحت أشعة الشمس المباشرة) وحاويات مقاومة للطقس مصنفة لنطاق درجات الحرارة في الرياض وأسطح شاشات مقاومة للأشعة فوق البنفسجية. تحدد ويندو للإعلان الشاشات الخارجية المناسبة لبيئة التركيب المحددة."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "توفر ويندو للإعلان التوفير والتركيب الكامل. يتولى فريق التركيب لدينا التثبيت على الحائط والتعليق من السقف وتجميع ستاندات الشاشات القائمة بذاتها وإدارة الكابلات والاتصال بالشبكة وإعداد البرمجيات الأولي. ننسق المتطلبات الكهربائية مع مقاول العميل ونجري التشغيل والاختبار قبل التسليم."
      }
    }
  ]
}
