...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'شركة إدارة فعاليات في الرياض | وينوو للإعلان',
            'meta_description' => 'وينوو للإعلان شركة إدارة فعاليات متكاملة في الرياض — نخطط وننفذ فعاليات الشركات وإطلاق المنتجات وحفلات التكريم والمناسبات الخاصة في جميع أنحاء المملكة. تواصل معنا للحصول على استشارة مجانية.',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>وينوو للإعلان هي شركة إدارة فعاليات متكاملة في الرياض، موثوقة من قبل الشركات والجهات الحكومية والعلامات التجارية في جميع أنحاء المملكة العربية السعودية. من العشاء التنفيذي الحميم إلى احتفالات اليوم الوطني الكبرى، ندير كل التفاصيل — حتى تتمكن من التركيز على ضيوفك.</p>
...
<p>في وينوو للإعلان، نعامل كل فعالية كفرصة للعلامة التجارية. كل تفصيل، من خلفية المدخل إلى المسرح ذي العلامة التجارية وهدايا الضيوف، يعبر عن هويتك.</p>
...
<p>تختار الشركات في جميع أنحاء المملكة العربية السعودية وينوو للإعلان لأننا نمتلك سلسلة الإنتاج بالكامل داخلياً. لا نستعين بمصادر خارجية لفعاليتك — فريق التصميم والطباعة والتصنيع والخدمات اللوجستية يعملون جميعاً تحت سقف واحد. هذا يمنحنا سيطرة مباشرة على الجودة والجدول الزمني في كل مرحلة.</p>
...
<p>تعتمد تكاليف إدارة الفعاليات على حجم ونوع وتعقيد فعاليتك. توفر وينوو للإعلان أسعاراً مخصصة لكل ميزانية. تواصل معنا بملخص فعاليتك وسنقدم لك عرض سعر مفصل ومفصّل مجاناً.</p>

<h3>ما أنواع الفعاليات التي تديرها وينوو للإعلان؟</h3>
<p>تدير وينوو للإعلان مجموعة كاملة من الفعاليات المؤسسية والخاصة بما في ذلك إطلاق المنتجات وحفلات التكريم والحفلات السنوية واجتماعات المساهمين واحتفالات اليوم الوطني وتفعيل العلامات التجارية وفعاليات بناء الفريق في الرياض والمملكة العربية السعودية.</p>
...
<h3>هل تتولى وينوو للإعلان تصميم وديكور الفعاليات؟</h3>
...
<p>نعم. تدير وينوو للإعلان فعاليات في جميع أنحاء المملكة العربية السعودية بما في ذلك جدة والدمام ونيوم ومدن أخرى. يسافر فريقنا على مستوى المملكة لتقديم نفس مستوى الجودة بغض النظر عن الموقع.</p>

<h2>احصل على استشارة مجانية لفعاليتك</h2>
<p>هل أنت مستعد لبدء التخطيط لفعاليتك؟ تواصل مع وينوو للإعلان اليوم. شارك ملخص فعاليتك وسيرد فريقنا خلال 24 ساعة بالأفكار وعرض سعر مبدئي. ندير فعاليات بجميع الأحجام — من 50 إلى 5,000 ضيف.</p>
HTML;
    }
};
