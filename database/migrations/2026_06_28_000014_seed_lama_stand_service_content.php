...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'لاما ستاند في الرياض | استندات دعائية بتوتر القماش | وينوو للإعلان',
            'meta_description' => 'استندات لاما وأنظمة العرض بتوتر القماش المخصصة في الرياض — وينوو للإعلان ينتج استندات لاما للمعارض والفعاليات والإعلان الترويجي في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>تنتج وينوو للإعلان استندات اللاما في تكوينين رئيسيين:</p>
...
<p>تصمم وينوو للإعلان حزم عرض بوثات المعارض التي تجمع بين استندات اللاما والعناصر التكميلية — لضمان أن البوث بالكامل يحمل هوية بصرية موحدة. لقد زودنا أنظمة استندات اللاما لبوثات المعارض في أماكن متعددة عبر الرياض والمملكة العربية السعودية.</p>
...
<p>تستخدم وينوو للإعلان مخرجات طباعة عالية الدقة على قماش مصمم خصيصاً لأنظمة إطارات اللاما — مما يضمن ملاءمة الحشية المناسبة وشد القماش الصحيح وجودة طباعة تصمد عند مسافات المشاهدة القريبة وكذلك من جميع أنحاء مساحة المعرض.</p>
...
<p>توفر وينوو للإعلان تعليمات التركيب وخدمة التركيب في الموقع الاختيارية لتكوينات استندات اللاما الكبيرة أو المعقدة.</p>
