...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'تصميم ثلاثي الأبعاد في الرياض | تصور وتصميم 3D السعودية | ويندو للإعلان',
            'meta_description' => 'تصميم وتصور ثلاثي الأبعاد في الرياض — ويندو للإعلان يصمم تصورات ثلاثية الأبعاد وتصاميم منتجات وتصاميم معمارية ومحتوى رقمي ثلاثي الأبعاد للشركات في السعودية. دعاية واعلان الرياض. احصل على عرض سعر.',
...
<p>تصمم ويندو للإعلان تصييرات منتجات ثلاثية الأبعاد واقعية من الرسومات التقنية أو عينات المنتج الفعلية أو الصور المرجعية. الصور الناتجة جاهزة للاستخدام في المواد الإعلانية وملفات الشركات والكتالوجات وصفحات المنتجات الإلكترونية ومحتوى وسائل التواصل الاجتماعي.</p>
...
<p>قبل تصنيع بوث معرضي، يمنح التصور ثلاثي الأبعاد العميل معاينة واقعية لكيفية ظهور البوث النهائي في قاعة المعرض — من منظر المدخل إلى التجربة الداخلية. تصمم ويندو للإعلان تصورات ثلاثية الأبعاد للأجنحة المعرضية كجزء من عملية تصميم البوث، مما يتيح للعملاء تقييم التصميم وطلب التعديلات والموافقة على المفهوم قبل بدء الإنتاج.</p>
...
<p>النمذجة ثلاثية الأبعاد جزء لا يتجزأ من عملية التصميم لتطبيقات الهوية المؤسسية التي ستُصنع بأبعاد ثلاثية — حروف جدار الاستقبال ولافتات المباني وأعمدة اللافتات والعناصر الهيكلية للمعارض. تنتج ويندو للإعلان نماذج ثلاثية الأبعاد مفصلة لجميع عناصر اللافتات المصنعة، مما يتيح تصوراً دقيقاً لموافقة العميل ومواصفات تصنيع دقيقة لفريق الإنتاج.</p>
...
<p>ينتج الرسوم المتحركة ثلاثية الأبعاد محتوى حركي لا تستطيع التصييرات الثابتة تحقيقه — عروض منتجات دوارة ومناظر مفككة تُظهر البنية الداخلية وجولات معمارية ورسوميات حركية للعلامة التجارية. تنتج ويندو للإعلان رسوماً متحركة ثلاثية الأبعاد لـ<a href="/ar/services/digital-marketing">التسويق الرقمي</a> ومحتوى شاشات المعارض والفيديو المؤسسي ومحتوى وسائل التواصل الاجتماعي.</p>
...
<h3>ما أنواع التصميم ثلاثي الأبعاد التي تنتجها ويندو للإعلان؟</h3>
<p>تنتج ويندو للإعلان تصور المنتج ثلاثي الأبعاد (تصييرات واقعية للمنتجات المادية للإعلان والتجارة الإلكترونية)، وتصور البوث المعرضي ثلاثي الأبعاد (تصييرات ما قبل الإنتاج تُظهر كيف سيبدو البوث قبل التصنيع)، والتصور المعماري والداخلي ثلاثي الأبعاد (عرض العقارات والمكاتب والمساحات التجارية بتنسيق واقعي)، وتصميم الشعار وعناصر العلامة التجارية ثلاثية الأبعاد لمواصفات اللافتات والتصنيع، والمحتوى المتحرك ثلاثي الأبعاد للإعلان الرقمي والعروض التقديمية.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "ما أنواع التصميم ثلاثي الأبعاد التي تنتجها ويندو للإعلان؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تنتج ويندو للإعلان تصور المنتج ثلاثي الأبعاد (تصييرات واقعية للمنتجات المادية للإعلان والتجارة الإلكترونية)، وتصور البوث المعرضي ثلاثي الأبعاد (تصييرات ما قبل الإنتاج تُظهر كيف سيبدو البوث قبل التصنيع)، والتصور المعماري والداخلي ثلاثي الأبعاد (عرض العقارات والمكاتب والمساحات التجارية بتنسيق واقعي)، وتصميم الشعار وعناصر العلامة التجارية ثلاثية الأبعاد لمواصفات اللافتات والتصنيع، والمحتوى المتحرك ثلاثي الأبعاد للإعلان الرقمي والعروض التقديمية."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. تستخدم ويندو للإعلان النمذجة ثلاثية الأبعاد كأداة تصميم قبل التصنيع — بإنشاء نماذج ثلاثية الأبعاد مفصلة للافتات أو الحروف أو العناصر الهيكلية التي تعمل كتصور للعميل ومرجع للتصنيع. ينقل النموذج ثلاثي الأبعاد الأبعاد الدقيقة واختيارات الخامات ومتطلبات التجميع لفريق التصنيع. هذه ممارسة معيارية لمشاريع التصنيع ثلاثي الأبعاد المعقدة."
      }
    },
    {
      "@type": "Question",
