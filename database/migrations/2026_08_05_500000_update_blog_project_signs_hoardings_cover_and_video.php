...
return new class extends Migration
{
    ...
    private string $coverPath = 'blogs/covers/project-signs-hoarding-boards-saudi-arabia-window-v2.webp';
    private string $previousCoverPath = 'blogs/covers/project-signs-hoarding-boards-saudi-arabia-window.webp';
...
<div style="max-width: 360px; margin: 24px auto;">
    <div style="position: relative; padding-bottom: 177.78%; height: 0; border-radius: 12px; overflow: hidden;">
        <iframe src="https://www.youtube.com/embed/IcF3Ys2ARuY" title="Window Advertising Agency"
...
HTML;
    ...
    public function down(): void
    {
        ...
        if ($blog->cover === $this->coverPath) {
            DB::table('blogs')->where('id', $blog->id)->update(['cover' => $this->previousCoverPath]);
        }
    ...
    {
        $source = base_path('resources/blog-assets/project-signs-hoarding-boards-saudi-arabia-window-cover-v2.jpg');
        if (!is_file($source)) {
            return;
        }
    ...
    private function insertVideoAfterFirstComponent(int $blogId, string $locale): void
    {
        ...
        if (!$translation || str_contains($translation->description, 'youtube.com/embed/IcF3Ys2ARuY')) {
            return;
        }
