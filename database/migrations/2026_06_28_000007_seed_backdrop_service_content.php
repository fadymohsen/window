...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $arData = [
            ...
            'meta_title' => 'طباعة باك دروب في الرياض | خلفيات فعاليات السعودية | ويندو للإعلان',
...
HTML;
    ...
    {
        return <<<'HTML'
<p>كل صورة تُلتقط في فعاليتك هي محتوى يحمل علامتك التجارية. الباك دروب المطبوع باحترافية يضمن أن كل صورة تُشارَك من مؤتمرك أو حفل التكريم أو تجمعك المؤسسي تحمل علامتك التجارية في الخلفية. ويندو للإعلان تصمم وتطبع باك دروب الفعاليات للمؤسسات في جميع أنحاء الرياض والمملكة العربية السعودية — بإنتاج كامل يشمل نظام الإطار، من الطلب حتى التسليم.</p>
...
<p>تنتج ويندو للإعلان جميع أنواع باك دروب الفعاليات المستخدمة في سوق الإعلان والفعاليات السعودي:</p>
...
<p>تنتج ويندو للإعلان باك دروب مسارح المؤتمرات المصمم ليؤدي بهذا المستوى من الظهور. تتوافق تصاميمنا مع هوية فعاليتك، وتدمج شعارات الرعاة بشكل صحيح، وتُنتج بالدقة المطلوبة للظهور الحاد على تنسيقات المسارح الكبيرة. ننسق مع فريق فعالياتك بشأن الأبعاد ومتطلبات الإطار والجدول الزمني للتسليم ليتناسب مع جدول إنتاج فعاليتك. لبيئات فعاليات متكاملة تشمل بناء الأجنحة، استكشف خدمة <a href="/ar/services/exhibition-booth-execution">تنفيذ أجنحة المعارض</a> لدينا.</p>

<h2>المواد وجودة الطباعة</h2>
<p>تتحدد جودة الباك دروب المطبوع بالمادة ودقة الطباعة المستخدمة. تستخدم ويندو للإعلان مواد ممتازة مختارة لاستوائها ودقة ألوانها وأدائها الفوتوغرافي:</p>
...
<p>تنتج ويندو للإعلان الباك دروب على القماش (قماش مشدود أو قماش بأسلوب الوسادة) وPVC فلكس والفينيل المطفي حسب التطبيق. باك دروب القماش ينتج لمسة نهائية احترافية خالية من التجاعيد وخفيف الوزن وقابل للنقل. باك دروب PVC يوفر جودة طباعة حادة للتصوير القريب. كلا الخيارين متاحان مع أو بدون أنظمة إطارات.</p>

<h3>هل توفرون إطار الباك دروب بالإضافة إلى الطباعة؟</h3>
<p>نعم. توفر ويندو للإعلان حزم باك دروب كاملة تشمل الرسم المطبوع ونظام إطار الألمنيوم. تشمل خيارات الإطارات الإطارات المستقيمة والإطارات المنحنية والأنظمة القائمة بذاتها القابلة للنقل. كما نوفر حوامل باك دروب لتطبيقات جدران التصوير الأصغر.</p>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "تنتج ويندو للإعلان الباك دروب على القماش (قماش مشدود أو قماش بأسلوب الوسادة) وPVC فلكس والفينيل المطفي حسب التطبيق. باك دروب القماش ينتج لمسة نهائية احترافية خالية من التجاعيد وخفيف الوزن وقابل للنقل. باك دروب PVC يوفر جودة طباعة حادة للتصوير القريب. كلا الخيارين متاحان مع أو بدون أنظمة إطارات."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نعم. توفر ويندو للإعلان حزم باك دروب كاملة تشمل الرسم المطبوع ونظام إطار الألمنيوم. تشمل خيارات الإطارات الإطارات المستقيمة والإطارات المنحنية والأنظمة القائمة بذاتها القابلة للنقل. كما نوفر حوامل باك دروب لتطبيقات جدران التصوير الأصغر."
      }
    },
    {
      "@type": "Question",
